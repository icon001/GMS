...
type
  ...
  private
    ...
    function FormTable_0029_VersionMake:Boolean;
    function FormTable_0030_VersionMake:Boolean;
    function FormTable_0031_VersionMake:Boolean;
    function FormTable_0032_VersionMake:Boolean;
    function FormTable_0033_VersionMake:Boolean;
    function FormTable_0034_VersionMake:Boolean;
    function FormTable_0035_VersionMake:Boolean;
    function FormTable_0036_VersionMake:Boolean;
    function FormTable_0037_VersionMake:Boolean;
    function FormTable_0038_VersionMake:Boolean;
    function FormTable_0039_VersionMake:Boolean;
    function FormTable_0040_VersionMake:Boolean;
  public
    { Public declarations }
...
begin
  ...
  if nTableVersion < 29 then FormTable_0029_VersionMake;
  if nTableVersion < 30 then FormTable_0030_VersionMake;
  if nTableVersion < 31 then FormTable_0031_VersionMake;
  if nTableVersion < 32 then FormTable_0032_VersionMake;
  if nTableVersion < 33 then FormTable_0033_VersionMake;
  if nTableVersion < 34 then FormTable_0034_VersionMake;
  if nTableVersion < 35 then FormTable_0035_VersionMake;
  if nTableVersion < 36 then FormTable_0036_VersionMake;
  if nTableVersion < 37 then FormTable_0037_VersionMake;
  if nTableVersion < 38 then FormTable_0038_VersionMake;
  if nTableVersion < 39 then FormTable_0039_VersionMake;
...
begin
  ...
  dmDBInsert.InsertIntoTB_FORMNAME_All('2','2','0','BM5_012List','관리자 리스트','Manager List','0');
...
begin
  ...
  begin
    stSql := ' Update TB_FORMNAME Set ';
    stSql := stSql + ' FN_NAME2 = ';
    stSql := stSql + ' (SELECT ';
    stSql := stSql + ' FN_NAME2 ';
    stSql := stSql + ' FROM TB_FORMNAME ';
    stSql := stSql + ' WHERE where FN_PROGRAMGUBUN = ''2'' and FN_NAMECODE = ''BM4_020'' ';
    stSql := stSql + ' ), ';
    ...
    stSql := stSql + ' WHERE where FN_PROGRAMGUBUN = ''2'' and FN_NAMECODE = ''BM4_020'' ';
    stSql := stSql + ' ) ';
    stSql := stSql + ' WHERE TB_FORMNAME.FN_PROGRAMGUBUN = ''4'' and TB_FORMNAME.FN_NAMECODE = ''BM3_031'' ';
    dmDataBase.ProcessExecSQL(stSql);
  end;
...
function TdmFormName.FormTable_0029_VersionMake: Boolean;
begin
  dmDBInsert.InsertIntoTB_FORMNAME_All('2','1','2','BM5_024','지문리더관리','FingerReader','1');
  dmDBInsert.InsertIntoTB_FORMNAME_All('3','1','0','BM5_024','지문리더를 등록/수정/삭제 할 수 있습니다.','FingerReader Manager','0');        //공통

  dmDBUpdate.UpdateTB_CONFIG_Field_StringValue('COMMON','FORMNAME_VER','CO_CONFIGVALUE','29');
end;

function TdmFormName.FormTable_0030_VersionMake: Boolean;
begin
  dmDBInsert.InsertIntoTB_FORMNAME_All('2','1','2','BM3_028','개인별권한관리','Employee GRADE','1');
  dmDBInsert.InsertIntoTB_FORMNAME_All('3','1','0','BM3_028','개인별권한관리를(을) 할 수 있습니다.','Employee GRADE','0');        //공통

  dmDBUpdate.UpdateTB_CONFIG_Field_StringValue('COMMON','FORMNAME_VER','CO_CONFIGVALUE','30');
end;

function TdmFormName.FormTable_0031_VersionMake: Boolean;
begin
  dmDBInsert.InsertIntoTB_FORMNAME_All('2','1','2','BM3_029','권한 재전송','Permit Resend','1');
  dmDBInsert.InsertIntoTB_FORMNAME_All('3','1','0','BM3_029','권한 재전송를(을) 할 수 있습니다.','Permit Resend','0');        //공통

  dmDBUpdate.UpdateTB_CONFIG_Field_StringValue('COMMON','FORMNAME_VER','CO_CONFIGVALUE','31');
end;

function TdmFormName.FormTable_0032_VersionMake: Boolean;
begin
  dmDBInsert.InsertIntoTB_FORMNAME_All('0','2','0','COMMONSERVERSTATE','서버상태','Server State','0');        //공통
  dmDBInsert.InsertIntoTB_FORMNAME_All('0','2','0','COMMONNODESTATE','노드상태','Node','0');
  dmDBInsert.InsertIntoTB_FORMNAME_All('0','2','0','COMMONDEVICESTATE','컨트롤러상태','Device','0');
  dmDBInsert.InsertIntoTB_FORMNAME_All('0','2','0','COMMONDOORSTATE','출입문상태','Device','0');
  dmDBInsert.InsertIntoTB_FORMNAME_All('0','2','0','COMMONARMAREASTATE','방범구역상태','Security Area','0');        //공통
  dmDBInsert.InsertIntoTB_FORMNAME_All('0','2','0','COMMONDOORNO','출입문번호','DOOR NO','0');        //공통
  dmDBInsert.InsertIntoTB_FORMNAME_All('0','2','0','COMMONUPLOADFILEFORMAT','업로드파일포맷','Upload File Format','0');        //공통
  dmDBInsert.InsertIntoTB_FORMNAME_All('0','2','0','COMMONFILEUPLOAD','파일업로드','File Upload','0');        //공통
  dmDBInsert.InsertIntoTB_FORMNAME_All('0','2','0','COMMONNOTACCPERMIT','출입권한불가','Not Permission','0');
  dmDBInsert.InsertIntoTB_FORMNAME_All('0','2','0','COMMONSERVERMPORT','Monitoring Port','Monitoring Port','0');
  dmDBInsert.InsertIntoTB_FORMNAME_All('0','2','0','COMMONSERVERCPORT','Control Port','Control Port','0');
  dmDBInsert.InsertIntoTB_FORMNAME_All('0','2','0','COMMONSERVERTYPE','서버타입','Server Type','0');
  dmDBInsert.InsertIntoTB_FORMNAME_All('0','2','0','COMMONSERVERFPORT','FTP Port','FTP Port','0');
  dmDBInsert.InsertIntoTB_FORMNAME_All('0','2','0','COMMONSERVERDPORT','Direct Port','Direct Port','0');
  dmDBInsert.InsertIntoTB_FORMNAME_All('0','2','0','COMMONSERVERSOCKETTYPE','소켓타입','Socket Type','0');
  dmDBInsert.InsertIntoTB_FORMNAME_All('0','2','0','COMMONFIREGROUP','화재그룹','FIRE GROUP','0');        //공통
  dmDBInsert.InsertIntoTB_FORMNAME_All('0','2','0','COMMONFINGERIP','지문리더IP','Finger Reader IP','0');        //공통
  dmDBInsert.InsertIntoTB_FORMNAME_All('0','2','0','COMMONFINGERNAME','지문리더명','Finger Reader','0');        //공통
  dmDBInsert.InsertIntoTB_FORMNAME_All('0','2','0','COMMONFINGERRESEND','지문재전송','Finger ReSend','0');        //공통
  dmDBInsert.InsertIntoTB_FORMNAME_All('0','2','0','COMMONFINGERNO','지문리더번호','Finger NO','0');        //공통
  dmDBInsert.InsertIntoTB_FORMNAME_All('0','2','0','COMMONFINGERTYPE','지문리더타입','Finger Type','0');        //공통
  dmDBInsert.InsertIntoTB_FORMNAME_All('0','2','0','COMMONRELAYDOOR','연동출입문','Relay Door','0');        //공통
  dmDBInsert.InsertIntoTB_FORMNAME_All('0','2','0','COMMONCONTROLUSED','컨트롤러사용유무','Controler Use','0');        //공통
  dmDBInsert.InsertIntoTB_FORMNAME_All('0','2','0','COMMONHIDE','숨기기','Hide','0');        //공통
  dmDBInsert.InsertIntoTB_FORMNAME_All('0','2','0','COMMONVISIBLE','보이기','Visible','0');        //공통
  dmDBInsert.InsertIntoTB_FORMNAME_All('0','2','0','COMMONARMAREAUSED','방범구역사용유무','ArmArea Use','0');        //공통
  dmDBInsert.InsertIntoTB_FORMNAME_All('0','2','0','COMMONATDOOR','근태사용유무','Attend Use','0');        //공통
  dmDBInsert.InsertIntoTB_FORMNAME_All('0','2','0','COMMONFDDOOR','식수사용유무','Food Use','0');        //공통
  dmDBInsert.InsertIntoTB_FORMNAME_All('0','2','0','COMMONUSECONTROLER','사용컨트롤러','Use Controller','0');        //공통
  dmDBInsert.InsertIntoTB_FORMNAME_All('0','2','0','COMMONNOTUSECONTROLER','미사용컨트롤러','Unused Controller','0');        //공통
  dmDBInsert.InsertIntoTB_FORMNAME_All('0','2','0','COMMONGRADE','권한','Grade','0');        //공통
  dmDBInsert.InsertIntoTB_FORMNAME_All('0','2','0','COMMONCRITICALLIST','필수항목리스트','Critical List','0');
  dmDBInsert.InsertIntoTB_FORMNAME_All('0','2','0','COMMONMENU','메뉴','Menu','0');
  dmDBInsert.InsertIntoTB_FORMNAME_All('0','2','0','COMMONFIELD','필드명','Field','0');
  dmDBInsert.InsertIntoTB_FORMNAME_All('0','2','0','COMMONCRITICALUSED','필수항목사용유무','Critical Used','0');

  dmDBUpdate.UpdateTB_CONFIG_Field_StringValue('COMMON','FORMNAME_VER','CO_CONFIGVALUE','32');
end;

function TdmFormName.FormTable_0033_VersionMake: Boolean;
begin
  dmDBInsert.InsertIntoTB_FORMNAME_All('0','2','0','COMMONVIEWSEQ','조회순서','View Seq','0');

  dmDBUpdate.UpdateTB_CONFIG_Field_StringValue('COMMON','FORMNAME_VER','CO_CONFIGVALUE','33');
end;

function TdmFormName.FormTable_0034_VersionMake: Boolean;
begin
  dmDBInsert.InsertIntoTB_FORMNAME_All('2','1','2','BM4_026','미사용 카드 보고서','UnUsed Card Report','1');
  dmDBInsert.InsertIntoTB_FORMNAME_All('3','1','0','BM4_026','미사용 카드 내역을 조회합니다.','UnUsed Card Report','0');        //공통

  dmDBInsert.InsertIntoTB_FORMNAME_All('0','2','0','COMMONLASTUSEDDATE','마지막 사용일','Last Used Date','0');
  dmDBInsert.InsertIntoTB_FORMNAME_All('0','2','0','COMMONLASTUSEDDATENULL','사용일자 없음 포함','Last Used Date','0');
  dmDBInsert.InsertIntoTB_FORMNAME_All('0','2','0','BUTTONCARDDELETE','선택카드 삭제','Card Delete','0');


  dmDBUpdate.UpdateTB_CONFIG_Field_StringValue('COMMON','FORMNAME_VER','CO_CONFIGVALUE','34');
end;

function TdmFormName.FormTable_0035_VersionMake: Boolean;
begin
//
  dmDBInsert.InsertIntoTB_FORMNAME_All('0','2','0','COMCHILDSYNC','상위권한동기화','Parent Grade Sync','0');
  dmDBUpdate.UpdateTB_CONFIG_Field_StringValue('COMMON','FORMNAME_VER','CO_CONFIGVALUE','35');
end;

function TdmFormName.FormTable_0036_VersionMake: Boolean;
begin
  dmDBInsert.InsertIntoTB_FORMNAME_All('0','2','0','COMMONBUILDINGMONITORING','빌딩별모니터링','Building Type','0','Building Type');        //공통

  dmDBUpdate.UpdateTB_CONFIG_Field_StringValue('COMMON','FORMNAME_VER','CO_CONFIGVALUE','36');

end;

function TdmFormName.FormTable_0037_VersionMake: Boolean;
begin
  dmDBInsert.InsertIntoTB_FORMNAME_All('0','2','0','COMMONCONTROLERINFO','컨트롤러정보','Controler Info','0','Controler Info');        //공통
  dmDBInsert.InsertIntoTB_FORMNAME_All('0','2','0','COMMONIPCHANGE','아이피변경','IP Change','0','IP Change');
  dmDBInsert.InsertIntoTB_FORMNAME_All('0','2','0','COMMONCONTROLERCHANGE','컨트롤러교체','Controler Change','0','Controler Change');        //공통
  dmDBInsert.InsertIntoTB_FORMNAME_All('0','2','0','COMMONFINGERINFO','지문리더정보','Finger Reader Info','0','Finger Reader Info');        //공통
  dmDBInsert.InsertIntoTB_FORMNAME_All('0','2','0','COMMONFINGERCHANGE','지문리더교체','Finger Reader Change','0','Finger Reader Change');        //공통

  dmDBUpdate.UpdateTB_CONFIG_Field_StringValue('COMMON','FORMNAME_VER','CO_CONFIGVALUE','37');
end;

function TdmFormName.FormTable_0038_VersionMake: Boolean;
begin
  dmDBInsert.InsertIntoTB_FORMNAME_All('0','2','0','NONCOMPANYEMPLOYEE','해당소속외직원','Non Company','0','Non Company');        //공통

  dmDBUpdate.UpdateTB_CONFIG_Field_StringValue('COMMON','FORMNAME_VER','CO_CONFIGVALUE','38');
end;

function TdmFormName.FormTable_0039_VersionMake: Boolean;
begin
  dmDBUpdate.UpdateTB_FORMNAME_Name('0','2','0','COMMONFINGERNO','지문리더순번');

  dmDBUpdate.UpdateTB_CONFIG_Field_StringValue('COMMON','FORMNAME_VER','CO_CONFIGVALUE','39');
end;

function TdmFormName.FormTable_0040_VersionMake: Boolean;
begin
  dmDBInsert.InsertIntoTB_FORMNAME_All('2','1','2','BM2_0151','카드구분관리','CardGubunCode','1');
  dmDBInsert.InsertIntoTB_FORMNAME_All('2','1','2','BM2_0152','출입승인코드관리','AccessStateCode','1');
  dmDBInsert.InsertIntoTB_FORMNAME_All('2','1','2','BM2_0153','알람상태코드관리','AlarmStateCode','1');
  dmDBInsert.InsertIntoTB_FORMNAME_All('2','1','2','BM2_0321','존맵관리','Zone Map','1');

  dmDBInsert.InsertIntoTB_FORMNAME_All('0','2','0','COMMONALARMGROUP','경보그룹','Alarm Group','0','Alarm Group');        //공통
  dmDBInsert.InsertIntoTB_FORMNAME_All('0','2','0','COMMONALARMEVENTCODE','알람이벤트코드','Alarm code','0','Alarm code');        //공통
  dmDBInsert.InsertIntoTB_FORMNAME_All('0','2','0','COMMONALARMEVENTNAME','알람이벤트명','Alarm name','0','Alarm name');        //공통
  dmDBInsert.InsertIntoTB_FORMNAME_All('0','2','0','COMMONALARMVIEW','알람이벤트표시','Alarm View','0','Alarm View');        //공통
  dmDBInsert.InsertIntoTB_FORMNAME_All('0','2','0','COMMONALARMSOUND','알람이벤트소리','Alarm Sound','0','Alarm Sound');        //공통
  dmDBInsert.InsertIntoTB_FORMNAME_All('0','2','0','COMMONALARMCOLOR','알람색상','Alarm Color','0','Alarm Color');        //공통
  dmDBInsert.InsertIntoTB_FORMNAME_All('0','2','0','COMMONSELECTSETTING','선택설정','Select Setting','0','Select Setting');        //공통
  dmDBInsert.InsertIntoTB_FORMNAME_All('0','2','0','COMMONALARMVIEWCHANGE','알람이벤트표시변경','Alarm View Change','0','Alarm View Change');        //공통
  dmDBInsert.InsertIntoTB_FORMNAME_All('0','2','0','COMMONALARMSOUNDCHANGE','알람이벤트소리변경','Alarm Sound Change','0','Alarm Sound Change');        //공통
  dmDBInsert.InsertIntoTB_FORMNAME_All('0','2','0','COMMONALARMCOLORCHANGE','알람색상변경','Alarm Color Change','0','Alarm Color Change');        //공통

  dmDBInsert.InsertIntoTB_FORMNAME_All('0','2','0','COMMONCARDGUBUNCODE','카드구분코드','Code','0','Code');        //공통
  dmDBInsert.InsertIntoTB_FORMNAME_All('0','2','0','COMMONCARDGUBUNNAME','카드구분','Card Gubun','0','Card Gubun');        //공통
  dmDBInsert.InsertIntoTB_FORMNAME_All('0','2','0','COMMONCARDRELAYTYPE','카드연동','Card Relay','0','Card Relay');        //공통
  dmDBInsert.InsertIntoTB_FORMNAME_All('0','2','0','COMMONZONESELECT','존선택','Select Zone','0','Select Zone');        //공통
  dmDBInsert.InsertIntoTB_FORMNAME_All('0','2','0','COMMONZONMAPMONITORING','존맵 모니터링','Select Zone','0','Select Zone');        //공통

  dmDBUpdate.UpdateTB_CONFIG_Field_StringValue('COMMON','FORMNAME_VER','CO_CONFIGVALUE','40');
end;
