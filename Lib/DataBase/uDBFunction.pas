...
type
  ...
  public
    ...
    function CheckTB_ACademyAttend_Key(aDate,aEmSeq:string;var aInstate,aOutstate:string):integer;
    function CheckTB_ACademyAttendSummary_Key(aDate,aEmSeq:string):integer;
    function CheckTB_AcademySMSSend_EmSeq(aDate,aEmSeq,aGubun,aAtGubun:string):integer;
    function CheckTB_AcademySMSSend_SendComplete(aDate,aEmSeq,aGubun,aAtGubun:string):integer;
    ...
    function CheckTB_ARMAREA(aNodeNo,aEcuID,aExtendID,aArmAreaNo:string):integer;
    ...
    function CheckTB_ATTENDEVENT_Value(aDate, aEmSeq:string):integer;
    ...
    function CheckTB_CARD_EMSEQ(aEmSeq:string):integer;
    function CheckTB_CARD_FingerCard(aEmSeq:string;var aFingerCard,aFingerCardState:string):integer;
    function CheckTB_CARD_FingerCard_CardPosition(aEmSeq:string;var aFingerCard,aFingerCardState,aCardPos:string):integer;
    ...
    function CheckTB_CertificateID_Key(aCertificateCode,aEmSeq:string):integer;
    function CheckTB_CertificateReceipt_Key(aCode,aDate,aEmSeq:string):integer;
    ...
    function CheckTB_EMPLOYEE_DupGroupNum(aEmSeq,aPhone:string; var aCgNum:string;var aEmName:string):integer;
    ...
    function CheckTB_Door(aNodeNo,aEcuID,aDoorNo:string):integer;
    ...
    function checkTB_EMPLOYEE_EMCODE_Variable(aEmCode:string;var aEmSeq,aACType,aATType,aFDType,aEmName,aValidDate:string):integer;
    function CheckTB_EMPLOYEE_EmGroupCodeLike(aEmGroupCode:string):integer;
    ...
    function CheckTB_EMPLOYEELecture_Key(aEmSeq,aLectureSeq:string;var aRegType:string):integer;
    function CheckTB_FINGERAPPROVALNUM_Sucess(aFingerUserID,aFingerDeviceSeq:string):integer;
    function CheckTB_FINGERDEVICE_FingerDeviceID(aFingerDeviceID,aFingerSeq:string):integer;
    ...
    function CheckTB_FINGERDEVICECARD_SENDSTATE(aFNDEVICESEQ,aPOSITIONNUM,aSendState:string;var aPermit:string):integer;
    ...
    function CheckTB_ZONE_Key(aNodeNo,aEcuID,aExtendID,aZoneNo:string):integer;
    function CheckTB_ZONEEXTENTION_Key(aNodeNo,aEcuID,aExtendID:string):integer;
    ...
    function GetNextTB_ACademyAttendMakeupLesson_Seq(aDate,aEmSeq:string):integer;
    ...
    function GetNextTB_CARDGUBUN_ID : string;
    function GetNextTB_CARD_PositionNum : string;
    function GetNextTB_CARD_RelayID : string;
    function GetNextTB_CCTV_No : string;
    function GetNextTB_CertificateCode_Seq : string;
    function GetNextTB_CERTIFICATEClassCode_ChildCode(aParentCode:string;var aCode,aDeepSeq,aViewSeq:string) : string;
    function GetNextTB_CertificatePlan_SEQ(aCode:string):string;
    function GetNextTB_COMPANYCODE_ChildCompanyCode(aParentCode:string;var aCode,aDeepSeq,aViewSeq:string):Boolean;
    function GetNextTB_consultinggroupphonenum_groupnum : string;
    function GetNextTB_CurriculumCode_Seq:string;
    ...
    function GetNextTB_FINGERDEVICE_Seq : string;
    ...
    function GetNextTB_LectureClassCode_ChildCode(aParentCode:string;var aCode,aDeepSeq,aViewSeq:string) : string;
    function GetNextTB_POSICODE:string;
    function GetNextTB_TuitionOFFCode:string;
    function GetLastCardPos : integer; //최종 카드번호를 추출하자.
    ...
    function GetTB_ACademyAttend_InOperator(aDate,aEmSeq:string;var aOutTime:string):string;
    function GetTB_ACademyAttend_OutOperator(aDate,aEmSeq:string):string;
    function GetTB_AcademySMSMessage_Message(aGubun,aAtGubun:string):string;
    ...
    function GetTB_CARD_EmSeqFromCardNo(aCardNo:string):integer;
    function GetTB_CARD_FingerCardNo(aPositionNum:string=''):string;
    function GetTB_CARD_FingerUserID(aEmSeq:string):string;
    ...
    function GetTB_CERTIFICATEClassCode_CurrentDeepSeq(aOrgCode:string):string;
    function GetTB_CERTIFICATEClassCode_ViewSeq(aCode:string):string;
    ...
    function GetTB_EMPLOYEE_CompanyPhone(aEmSeq:string):string;
    ...
    function GetTB_FINGERAPPROVALNUM_FingerDeviceSeq(aClientIP,aFingerUserID, aFingerDeviceSeq:string;var aEmSeq:string):integer;
    function GetTB_FINGERDEVICE_DeviceInfo(aFingerSeq:string; var aNodeNo,aEcuID,aType,aDoorNo:string):Boolean;
    function GetTB_FINGERDEVICE_FingerDeviceID(aNodeNo,aEcuID,aExtendID,aDoorID,aType:string):integer;
    function GetTB_FINGERDEVICE_FingerDeviceIP(aNodeNo,aEcuID,aExtendID,aDoorID,aType:string):string;
    function GetTB_FINGERDEVICE_FingerDeviceSeq(aNodeNo,aEcuID,aExtendID,aDoorID,aType:string):integer;
    function GetTB_FINGERDEVICE_FingerInfo(aFingerSeq:string; var aFingerID,aFingerIP,aFingerPort,aFingerName:string):Boolean;
//    Function GetTB_FORMNAME_Name(aProgramGubun,aMenuGubun,aNameCode,aLangType:string):string;
    function GetTB_LectureClassCode_AllName(aCode:string):string;
    function GetTB_LectureClassCode_CurrentDeepSeq(aOrgCode:string):string;
    function GetTB_LectureClassCode_ViewSeq(aCode:string):string;
    function GetTB_NODE_NextDeviceID(aSockType:string;var aNodeNo,aDeviceID:string):Boolean;
    function GetTB_NODE_NodeAddr(aNodeNo:string):string;
    ...
    function GetTB_ZONE_ZoneName(aNodeNo,aECUID,aExtendID,aLoop:string):string;
    function GetTB_ZONEEXTENTION_Type(aNodeNo,aEcuID,aExtendID:string):string;
  end;
...
function TdmDBFunction.CheckTB_ACademyAttendSummary_Key(aDate,
...
begin
  result := -1;
  stSql := 'select * from TB_ACademyAttendSummary ';
  stSql := stSql + ' Where AS_DATE = ''' + aDate + ''' ';
...
function TdmDBFunction.CheckTB_ACademyAttend_Key(aDate,
  aEmSeq: string;var aInstate,aOutstate:string): integer;
var
  stSql : string;
  TempAdoQuery :TADOQuery;
begin
  result := -1;
  stSql := 'select * from TB_ACademyAttend ';
  stSql := stSql + ' Where AA_DATE = ''' + aDate + ''' ';
  stSql := stSql + ' AND EM_SEQ = ' + aEmSeq + ' ';
  ...
  Try
    ...
    begin
      ...
      begin
        aInstate :=  FindField('AA_INTIME').AsString;
        aOutstate :=  FindField('AA_OUTTIME').AsString;
        result := 1;
      end;
    end;
  Finally
...
function TdmDBFunction.CheckTB_AcademySMSSend_EmSeq(aDate, aEmSeq, aGubun,
  aAtGubun: string): integer;
var
  stSql : string;
  TempAdoQuery :TADOQuery;
begin
  result := -1;
  stSql := 'select * from TB_AcademySMSSend ';
  stSql := stSql + ' Where AS_DATE = ''' + aDate + ''' ';
  stSql := stSql + ' AND EM_SEQ = ' + aEmSeq + ' ';
  stSql := stSql + ' AND AS_GUBUN = ' + aGubun + ' ';
  stSql := stSql + ' AND AS_ATGUBUN = ' + aAtGubun + ' ';
  stSql := stSql + ' AND AS_SENDSTATE <> ''N''';
...
function TdmDBFunction.CheckTB_AcademySMSSend_SendComplete(aDate, aEmSeq,
  aGubun, aAtGubun: string): integer;
var
  stSql : string;
  TempAdoQuery :TADOQuery;
begin
...
function TdmDBFunction.CheckTB_ARMAREA(aNodeNo, aEcuID, aExtendID,
...
function TdmDBFunction.CheckTB_ATTENDEVENT_Value(aDate,
  aEmSeq: string): integer;
var
  stSql : string;
  TempAdoQuery :TADOQuery;
...
function TdmDBFunction.CheckTB_CARD_EMSEQ(aEmSeq: string): integer;
var
  stSql : string;
  TempAdoQuery :TADOQuery;
begin
...
function TdmDBFunction.CheckTB_CARD_FingerCard_CardPosition(aEmSeq: string;
  var aFingerCard, aFingerCardState, aCardPos: string): integer;
var
  stSql : string;
  TempAdoQuery :TADOQuery;
begin
  ...
  Try
    ...
    begin
      ...
      begin
        aFingerCard := FindField('CA_CARDNO').AsString;
        aFingerCardState := FindField('CA_STATECODE').AsString;
        aCardPos := FindField('CA_POSITIONNUM').AsString;
      end;
    end;
  Finally
    TempAdoQuery.EnableControls;
...
function TdmDBFunction.CheckTB_CertificateID_Key(aCertificateCode,
  aEmSeq: string): integer;
var
  stSql : string;
  TempAdoQuery :TADOQuery;
begin
  result := -1;
  stSql := 'select * from TB_CertificateID ';
  stSql := stSql + ' Where  CF_CODE = ' + aCertificateCode + ' ';
  stSql := stSql + ' AND EM_SEQ = ' + aEmSeq + ' ';
...
function TdmDBFunction.CheckTB_CertificateReceipt_Key(aCode, aDate,
  aEmSeq: string): integer;
var
  stSql : string;
  TempAdoQuery :TADOQuery;
begin
  result := -1;
  stSql := 'select * from TB_CertificateReceipt ';
  stSql := stSql + ' Where  CF_CODE = ' + aCode + ' ';
...
begin
  ...
  stSql := stSql + ' OR ND_DIRECTPORT = ' + aServerPort + ' ';
...
function TdmDBFunction.CheckTB_Door(aNodeNo, aEcuID, aDoorNo: string): integer;
var
  stSql : string;
  TempAdoQuery :TADOQuery;
begin
...
function TdmDBFunction.CheckTB_EMPLOYEELecture_Key(aEmSeq, aLectureSeq: string;
  var aRegType: string): integer;
var
  stSql : string;
  TempAdoQuery :TADOQuery;
begin
  result := -1;
  stSql := 'select * from TB_EMPLOYEELecture ';
  stSql := stSql + ' Where  GROUP_CODE = ''' + G_stGroupCode + ''' ';
  stSql := stSql + ' AND EM_SEQ = ' + aEmSeq + ' ';
  ...
  Try
    ...
    begin
      ...
      aRegType := FindField('EL_STATE').AsString;
    end;
  Finally
    TempAdoQuery.EnableControls;
    TempAdoQuery.Free;
...
function TdmDBFunction.CheckTB_EMPLOYEE_DupGroupNum(aEmSeq, aPhone: string;
  var aCgNum, aEmName: string): integer;
var
  stSql : string;
  TempAdoQuery :TADOQuery;
begin
  ...
  stSql := stSql + ' Where  GROUP_CODE = ''' + G_stGroupCode + ''' ';
  stSql := stSql + ' AND EM_SEQ <> ' + aEmSeq + ' ';
  stSql := stSql + ' AND (EM_COMPANYPHONE = ''' + aPhone + ''' or EM_HOMEPHONE = ''' + aPhone + ''' or EM_HANDPHONE = ''' + aPhone + ''' ) ';
  ...
  Try
    ...
    begin
      ...
      begin
        result := 1;
        aCgNum := FindField('CG_NUM').AsString;
        aEmName := FindField('EM_NAME').AsString;
      end;
    end;
  Finally
...
function TdmDBFunction.checkTB_EMPLOYEE_EMCODE_Variable(aEmCode: string;
  var aEmSeq, aACType, aATType, aFDType, aEmName,aValidDate: string): integer;
var
  stSql : string;
  TempAdoQuery :TADOQuery;
begin
  ...
  Try
    ...
    begin
      ...
      begin
        ...
        aValidDate := FindField('EM_ENDDATE').AsString;
      end;
    end;
  Finally
    TempAdoQuery.EnableControls;
...
function TdmDBFunction.CheckTB_EMPLOYEE_EmGroupCodeLike(
  aEmGroupCode: string): integer;
var
  stSql : string;
  TempAdoQuery :TADOQuery;
begin
...
function TdmDBFunction.CheckTB_FINGERAPPROVALNUM_Sucess(aFingerUserID,
  aFingerDeviceSeq: string): integer;
var
  stSql : string;
  TempAdoQuery :TADOQuery;
begin
  ...
  stSql := stSql + ' Where  GROUP_CODE = ''' + G_stGroupCode + ''' ';
  stSql := stSql + ' AND FN_DEVICESEQ = ' + aFingerDeviceSeq + ' ';
  stSql := stSql + ' AND CA_POSITIONNUM = ' + aFingerUserID + '';
  //stSql := stSql + ' AND FD_SEND = ''Y'' ';
  ...
  Try
    ...
    begin
      ...
      if (FindField('FD_SEND').AsString = 'Y') then result := 1
      else if FindField('FD_SEND').AsString = 'F' then result := 0;
...
function TdmDBFunction.CheckTB_FINGERDEVICECARD_SENDSTATE(aFNDEVICESEQ,
  aPOSITIONNUM, aSendState: string;var aPermit:string): integer;
var
  stSql : string;
  TempAdoQuery :TADOQuery;
begin
...
function TdmDBFunction.CheckTB_FINGERDEVICE_FingerDeviceID(
  aFingerDeviceID,aFingerSeq: string): integer;
var
  stSql : string;
  TempAdoQuery :TADOQuery;
begin
  ...
  stSql := stSql + ' Where  GROUP_CODE = ''' + G_stGroupCode + ''' ';
  stSql := stSql + ' AND FN_FINGERDEVICEID = ' + aFingerDeviceID + ' ';
...
function TdmDBFunction.CheckTB_LecturePaymentSummary_Key(aMonth,
  aEmSeq: string): integer;
var
  stSql : string;
  TempAdoQuery :TADOQuery;
begin
  result := -1;
  stSql := 'select * from TB_LecturePaymentSummary ';
  stSql := stSql + ' Where  GROUP_CODE = ''' + G_stGroupCode + ''' ';
  stSql := stSql + ' AND LP_MONTH = ''' + aMonth + ''' ';
  stSql := stSql + ' AND EM_SEQ = ' + aEmSeq + ' ';
...
function TdmDBFunction.CheckTB_Tuition_LikeCompanyCode(aSeq,
  aCompanyCode: string): integer;
var
  stSql : string;
  TempAdoQuery :TADOQuery;
...
begin
  result := -1;
  stSql := 'select * from TB_Tuition ';
  stSql := stSql + ' Where  GROUP_CODE = ''' + G_stGroupCode + ''' ';
  stSql := stSql + ' AND CC_CODE = ' + aSeq + ' ';
  stSql := stSql + ' AND ( CO_COMPANYCODE Like ''' + aCompanyCode + '%''';
  if(Length(aCompanyCode) > 1 ) then
  begin
    stSql := stSql + ' OR CO_COMPANYCODE = ''0'' ';
    len := 1;
    while len < Length(aCompanyCode) do
    begin
      stSql := stSql + ' OR CO_COMPANYCODE = ''' + copy(aCompanyCode,1,len+G_nCompanyCodeLength) + ''' ';
      len := len + G_nCompanyCodeLength;
    end;
  end;
  stSql := stSql + ')';
  Try
...
function TdmDBFunction.CheckTB_ZONEEXTENTION_Key(aNodeNo, aEcuID,
  aExtendID: string): integer;
var
  stSql : string;
  TempAdoQuery :TADOQuery;
begin
  result := -1;
  stSql := 'select * from TB_ZONEEXTENTION ';
  stSql := stSql + ' Where  GROUP_CODE = ''' + G_stGroupCode + ''' ';
  stSql := stSql + ' AND ND_NODENO = ' + aNodeNo + ' ';
  stSql := stSql + ' AND DE_ECUID = ''' + aEcuID + '''';
  stSql := stSql + ' AND DE_EXTENDID = ' + aExtendID + ' ';
...
function TdmDBFunction.CheckTB_ZONE_Key(aNodeNo, aEcuID, aExtendID,
  aZoneNo: string): integer;
var
  stSql : string;
  TempAdoQuery :TADOQuery;
begin
  result := -1;
  stSql := 'select * from TB_ZONE ';
  stSql := stSql + ' Where  GROUP_CODE = ''' + G_stGroupCode + ''' ';
  stSql := stSql + ' AND ND_NODENO = ' + aNodeNo + ' ';
  stSql := stSql + ' AND DE_ECUID = ''' + aEcuID + '''';
  stSql := stSql + ' AND DE_EXTENDID = ' + aExtendID + ' ';
...
function TdmDBFunction.GetLastCardPos: integer;
var
  stSql : string;
  TempAdoQuery :TADOQuery;
begin
  ...
  stSql := stSql + ' AND CO_CONFIGCODE = ''LASTCARDPOS'' ';
  ...
  Try
    ...
    begin
      ...
      End;
      if recordCount < 1 then Exit;
      if FindField('CO_CONFIGVALUE').IsNull then Exit;
      if Not isDigit(FindField('CO_CONFIGVALUE').AsString) then Exit;
...
function TdmDBFunction.GetNextTB_ACademyAttendMakeupLesson_Seq(aDate,
  aEmSeq: string): integer;
var
  stSql : string;
  TempAdoQuery :TADOQuery;
begin
  result := 1;
  stSql := 'select MAX(AM_SEQ) as AM_SEQ from TB_ACademyAttendMakeupLesson ';
  stSql := stSql + ' Where  GROUP_CODE = ''' + G_stGroupCode + ''' ';
  stSql := stSql + ' AND  AS_DATE = ''' + aDate + ''' ';
  stSql := stSql + ' AND  EM_SEQ = ' + aEmSeq + ' ';
  ...
  Try
    ...
    begin
      ...
      End;
      if recordCount < 1 then Exit;
      if FindField('AM_SEQ').IsNull then Exit;
      result := FindField('AM_SEQ').AsInteger + 1;
    end;
  Finally
    TempAdoQuery.EnableControls;
    TempAdoQuery.Free;
...
function TdmDBFunction.GetNextTB_CARDGUBUN_ID: string;
var
  stSql : string;
  TempAdoQuery :TADOQuery;
  stLastPos : string;
begin
  ...
  stSql := 'select MAX(CA_CARDGUBUN) as CA_CARDGUBUN from TB_CARDGUBUN ';
  stSql := stSql + ' Where  GROUP_CODE = ''' + G_stGroupCode + ''' ';
  ...
  Try
    ...
    begin
      ...
      End;
      if recordCount < 1 then Exit;
      if FindField('CA_CARDGUBUN').IsNull then Exit;
      result := inttostr(FindField('CA_CARDGUBUN').AsInteger + 1);
...
var
  ...
  stLastPos : string;
begin
  result := inttostr(GetLastCardPos + 1);
  dmDBUpdate.UpdateTB_CONFIG_Field_StringValue('COMMON','LASTCARDPOS','CO_CONFIGVALUE',result);
  ...
  Try
    ...
    begin
      ...
      if result < inttostr(FindField('CA_POSITIONNUM').AsInteger + 1)  then
      begin
...
function TdmDBFunction.GetNextTB_CERTIFICATEClassCode_ChildCode(
  aParentCode: string; var aCode, aDeepSeq, aViewSeq: string): string;
var
  stSql : string;
  TempAdoQuery : TADOQuery;
  nDeepSeq : integer;
...
begin
  ...
  stSql := stSql + ' Where GROUP_CODE = ''' + G_stGroupCode + ''' ';
  stSql := stSql + ' AND CC_CODE Like ''' + aParentCode + '%'' ';
  stSql := stSql + ' Order by CC_DEEPSEQ,CC_VIEWSEQ ';
  Try
    CoInitialize(nil);
    TempAdoQuery := TADOQuery.Create(nil);
    TempAdoQuery.Connection := dmDataBase.ADOConnection;
    ...
    begin
      ...
      begin
        if G_bApplicationTerminate then Exit;
        if FindField('CC_CODE').AsString = aParentCode then
        begin
          nDeepSeq := FindField('CC_DEEPSEQ').AsInteger;
          aDeepSeq := inttostr(nDeepSeq + 1);
        end;
        if FindField('CC_DEEPSEQ').AsInteger = (nDeepSeq + 1) then
        begin
          if nViewSeq < FindField('CC_VIEWSEQ').AsInteger  then nViewSeq := FindField('CC_VIEWSEQ').AsInteger;
          stTemp := FindField('CC_CODE').AsString;
...
function TdmDBFunction.GetNextTB_CertificateCode_Seq: string;
var
  stSql : string;
  TempAdoQuery :TADOQuery;
begin
  result := '1';
  stSql := 'select MAX(CF_CODE) as CF_CODE from TB_CertificateCode ';
  stSql := stSql + ' Where  GROUP_CODE = ''' + G_stGroupCode + ''' ';
  ...
  Try
    ...
    begin
      ...
      End;
      if recordCount < 1 then Exit;
      if FindField('CF_CODE').IsNull then Exit;
      result := inttostr(FindField('CF_CODE').AsInteger + 1);
    end;
  Finally
    TempAdoQuery.EnableControls;
    TempAdoQuery.Free;
...
function TdmDBFunction.GetNextTB_CertificatePlan_SEQ(aCode: string): string;
var
  stSql : string;
  TempAdoQuery : TADOQuery;
  stTemp : string;
begin
  result := '1';
  stSql := 'Select Max(CP_SEQ) as CP_SEQ from TB_CertificatePlan ';
  stSql := stSql + ' Where GROUP_CODE = ''' + G_stGroupCode + ''' ';
  ...
  Try
    ...
    begin
      ...
      if FindField('CP_SEQ').IsNull then Exit;
      result := inttostr(FindField('CP_SEQ').AsInteger + 1);
    end;
  Finally
    TempAdoQuery.EnableControls;
    TempAdoQuery.Free;
...
function TdmDBFunction.GetNextTB_consultinggroupphonenum_groupnum: string;
var
  stSql : string;
  TempAdoQuery :TADOQuery;
begin
  result := '1';
  stSql := 'select MAX(cg_num) as cg_num from TB_consultinggroupphonenum ';
  ...
  Try
    ...
    begin
      ...
      End;
      if recordCount < 1 then Exit;
      if FindField('cg_num').IsNull then Exit;
      result := inttostr(FindField('cg_num').AsInteger + 1);
    end;
  Finally
    TempAdoQuery.EnableControls;
    TempAdoQuery.Free;
...
function TdmDBFunction.GetNextTB_CurriculumCode_Seq: string;
var
  stSql : string;
  TempAdoQuery :TADOQuery;
begin
  result := '1';
  stSql := 'select MAX(CC_CODE) as CC_CODE from TB_CurriculumCode ';
  stSql := stSql + ' Where  GROUP_CODE = ''' + G_stGroupCode + ''' ';
  ...
  Try
    ...
    begin
      ...
      End;
      if recordCount < 1 then Exit;
      if FindField('CC_CODE').IsNull then Exit;
      result := inttostr(FindField('CC_CODE').AsInteger + 1);
    end;
  Finally
    TempAdoQuery.EnableControls;
    TempAdoQuery.Free;
...
begin
  ...
  stSql := 'Select Max(FN_FINGERDEVICEID) as FN_FINGERDEVICEID from TB_FINGERDEVICE ';
  stSql := stSql + ' Where GROUP_CODE = ''' + G_stGroupCode + ''' ';
  Try
    CoInitialize(nil);
    TempAdoQuery := TADOQuery.Create(nil);
    ...
    begin
      ...
      End;
      if RecordCount < 1 then Exit;
      if FindField('FN_FINGERDEVICEID').IsNull then Exit;
      result := inttostr(FindField('FN_FINGERDEVICEID').AsInteger + 10);
    end;
  Finally
    TempAdoQuery.EnableControls;
    TempAdoQuery.Free;
...
function TdmDBFunction.GetNextTB_FINGERDEVICE_Seq: string;
var
  stSql : string;
  TempAdoQuery : TADOQuery;
  stTemp : string;
...
function TdmDBFunction.GetNextTB_LectureClassCode_ChildCode(aParentCode:string;var aCode,aDeepSeq,aViewSeq:string): string;
var
  stSql : string;
  TempAdoQuery : TADOQuery;
  nDeepSeq : integer;
...
begin
  ...
  stSql := stSql + ' Where GROUP_CODE = ''' + G_stGroupCode + ''' ';
  stSql := stSql + ' AND LC_CODE Like ''' + aParentCode + '%'' ';
  stSql := stSql + ' Order by LC_DEEPSEQ,LC_VIEWSEQ ';
  Try
    CoInitialize(nil);
    TempAdoQuery := TADOQuery.Create(nil);
    TempAdoQuery.Connection := dmDataBase.ADOConnection;
    ...
    begin
      ...
      begin
        if G_bApplicationTerminate then Exit;
        if FindField('LC_CODE').AsString = aParentCode then
        begin
          nDeepSeq := FindField('LC_DEEPSEQ').AsInteger;
          aDeepSeq := inttostr(nDeepSeq + 1);
        end;
        if FindField('LC_DEEPSEQ').AsInteger = (nDeepSeq + 1) then
        begin
          if nViewSeq < FindField('LC_VIEWSEQ').AsInteger  then nViewSeq := FindField('LC_VIEWSEQ').AsInteger;
          stTemp := FindField('LC_CODE').AsString;
          stTemp := copy(stTemp,1 + (((nDeepSeq) * G_nEmployeeGroupLength) + 1 ),G_nEmployeeGroupLength);
          Try
            if nChildCode < strtoint(stTemp)  then nChildCode := strtoint(stTemp);
          Except
...
function TdmDBFunction.GetNextTB_TuitionOFFCode: string;
var
  stSql : string;
  TempAdoQuery : TADOQuery;
begin
  result := inttostr(1);
  stSql := 'Select Max(TO_CODE) as TO_CODE from TB_TuitionOFF ';
  stSql := stSql + ' Where GROUP_CODE = ''' + G_stGroupCode + ''' ';
  Try
    CoInitialize(nil);
    TempAdoQuery := TADOQuery.Create(nil);
    ...
    begin
      ...
      End;
      if recordCount < 1 then Exit;
      result := inttostr(FindField('TO_CODE').AsInteger + 1);
    end;
  Finally
    TempAdoQuery.EnableControls;
    TempAdoQuery.Free;
...
function TdmDBFunction.GetTB_ACademyAttend_InOperator(aDate,
  aEmSeq: string;var aOutTime:string): string;
var
  stSql : string;
  TempAdoQuery :TADOQuery;
begin
  ...
  Try
    ...
    begin
      ...
      End;
      if recordCount < 1 then Exit;
      result := FindField('AA_INOPERATOR').AsString;
      aOutTime := FindField('AA_OUTTIME').AsString;
    end;
  Finally
    TempAdoQuery.EnableControls;
    TempAdoQuery.Free;
...
function TdmDBFunction.GetTB_ACademyAttend_OutOperator(aDate,
  aEmSeq: string): string;
var
  stSql : string;
  TempAdoQuery :TADOQuery;
begin
  ...
  Try
    ...
    begin
      ...
      End;
      if recordCount < 1 then Exit;
      result := FindField('AA_OUTOPERATOR').AsString;
    end;
  Finally
    TempAdoQuery.EnableControls;
    TempAdoQuery.Free;
...
function TdmDBFunction.GetTB_AcademySMSMessage_Message(aGubun,
  aAtGubun: string): string;
var
  stSql : string;
  TempAdoQuery :TADOQuery;
begin
  result := '';
  stSql := 'select * from TB_AcademySMSMessage  ';
  stSql := stSql + ' Where AM_GUBUN = ' + aGubun + ' ';
  stSql := stSql + ' AND AM_ATGUBUN = ' + aAtGubun + ' ';
  Try
    CoInitialize(nil);
    TempAdoQuery := TADOQuery.Create(nil);
    TempAdoQuery.Connection := dmDataBase.ADOConnection;
    ...
    begin
      ...
      End;
      if recordCount < 1 then Exit;
      result := FindField('AM_MESSAGE').AsString;
    end;
  Finally
    TempAdoQuery.EnableControls;
    TempAdoQuery.Free;
...
function TdmDBFunction.GetTB_CARD_EmSeqFromCardNo(aCardNo: string): integer;
var
  stSql : string;
  TempAdoQuery :TADOQuery;
begin
  ...
  Try
    ...
    begin
      ...
      End;
      if recordcount < 1 then Exit;
      result := FindField('EM_SEQ').AsInteger;
    end;
  Finally
    TempAdoQuery.EnableControls;
    TempAdoQuery.Free;
...
function TdmDBFunction.GetTB_CARD_FingerCardNo(aPositionNum:string=''): string;
var
  stSql : string;
  TempAdoQuery :TADOQuery;
  nCardNo : integer;
...
begin
  ...
  begin
    if G_nFingerRelayType = 2 then stHexCardNo := Ascii2Hex(FillZeroStrNum(aPositionNum,G_nFPUserCardLength)) //G_nFPUserIDLength))
    else stHexCardNo := Ascii2Hex(FillZeroStrNum(aPositionNum,4)); //G_nFPUserIDLength)); -> 20171208 shf 2000 에서는 4바이트만 인식한다.
    if G_nCardNoType = 0 then stHexCardNo := stHexCardNo //시리얼 카드
    else if G_nCardNoType = 1 then stHexCardNo := FillCharString(stHexCardNo,'*',16)  //16바이트 카드
    else if G_nCardNoType = 2 then stHexCardNo := FillCharString(stHexCardNo,'*',16);//KT사옥타입
...
function TdmDBFunction.GetTB_CARD_FingerUserID(aEmSeq: string): string;
var
  stSql : string;
  TempAdoQuery :TADOQuery;
begin
  ...
  Try
    ...
    begin
      ...
      End;
      if recordcount < 1 then Exit;
      result := FindField('CA_POSITIONNUM').AsString;
    end;
  Finally
    TempAdoQuery.EnableControls;
    TempAdoQuery.Free;
...
function TdmDBFunction.GetTB_CERTIFICATEClassCode_CurrentDeepSeq(
...
begin
  ...
  Try
    ...
    begin
      ...
      begin
        if G_bApplicationTerminate then Exit;
        result := FindField('CC_DEEPSEQ').AsString;
        Next;
      end;
    end;
  Finally
...
function TdmDBFunction.GetTB_CERTIFICATEClassCode_ViewSeq(
  aCode: string): string;
var
  stSql : string;
  TempAdoQuery : TADOQuery;
begin
  ...
  Try
    ...
    begin
      ...
      begin
        if G_bApplicationTerminate then Exit;
        result := FindField('CC_VIEWSEQ').AsString;
        Next;
      end;
    end;
  Finally
...
function TdmDBFunction.GetTB_CompanyCode_ViewSeq(aCompanyCode: string): string;
var
  stSql : string;
  TempAdoQuery : TADOQuery;
begin
  ...
  Try
    ...
    begin
      ...
      begin
        if G_bApplicationTerminate then Exit;
        result := FindField('CO_VIEWSEQ').AsString;
        Next;
      end;
    end;
  Finally
...
function TdmDBFunction.GetTB_CONFIG_Value(aGroup, aCode: string): string;
var
  stSql : string;
  TempAdoQuery : TADOQuery;
begin
...
function TdmDBFunction.GetTB_consultinggroupphonenum_GroupNum(aNumber: string;
  var aGroupNum: string): integer;
var
  stSql : string;
  TempAdoQuery :TADOQuery;
begin
  result := -1;
  stSql := 'select * from TB_consultinggroupphonenum ';
  stSql := stSql + ' Where cg_phonenumber = ''' + aNumber + ''' ';
  Try
    CoInitialize(nil);
    TempAdoQuery := TADOQuery.Create(nil);
    TempAdoQuery.Connection := dmDataBase.ADOConnection;
...
function TdmDBFunction.GetTB_DEVICE_Version(aNodeNo, aEcuID: string): string;
var
  stSql : string;
  TempAdoQuery :TADOQuery;
begin
  ...
  Try
    ...
    begin
      ...
      End;
      if recordCount < 1 then Exit;
      result := FindField('DE_DEVICEVER').AsString;
    end;
  Finally
    TempAdoQuery.EnableControls;
    TempAdoQuery.Free;
...
function TdmDBFunction.GetTB_EMPLOYEE_CompanyPhone(aEmSeq: string): string;
var
  stSql : string;
  TempAdoQuery :TADOQuery;
begin
  ...
  Try
    ...
    begin
      ...
      End;
      if recordCount < 1 then Exit;
      result := FindField('EM_COMPANYPHONE').AsString;
    end;
  Finally
    TempAdoQuery.EnableControls;
    TempAdoQuery.Free;
...
function TdmDBFunction.GetTB_FINGERAPPROVALNUM_FingerDeviceSeq(aClientIP,
  aFingerUserID, aFingerDeviceSeq: string;var aEmSeq:string): integer;
var
  stSql : string;
  TempAdoQuery :TADOQuery;
begin
  ...
  stSql := 'select *  from TB_FINGERAPPROVALNUM ';
  stSql := stSql + ' Where GROUP_CODE = ''' + G_stGroupCode + ''' ';
  stSql := stSql + ' AND FN_DEVICEIP = ''' + aClientIP + ''' ';
  stSql := stSql + ' AND CA_POSITIONNUM = ' + aFingerUserID + ' ';
//  stSql := stSql + ' AND CA_POSITIONNUM = ' + aFingerUserID + ' ';
  Try
    CoInitialize(nil);
    ...
    begin
      ...
      End;
      if recordCount < 1 then Exit;
      result := FindField('FN_DEVICESEQ').AsInteger;
      aEmSeq := FindField('EM_SEQ').AsString;
    end;
  Finally
    TempAdoQuery.EnableControls;
...
function TdmDBFunction.GetTB_FINGERDEVICE_FingerDeviceID(aNodeNo, aEcuID,
  aExtendID, aDoorID, aType: string): integer;
var
  stSql : string;
  TempAdoQuery :TADOQuery;
begin
  ...
  Try
    ...
    begin
      ...
      End;
      if recordCount < 1 then Exit;
      result := FindField('FN_FINGERDEVICEID').AsInteger;
    end;
  Finally
    TempAdoQuery.EnableControls;
    TempAdoQuery.Free;
...
function TdmDBFunction.GetTB_FINGERDEVICE_FingerDeviceIP(aNodeNo, aEcuID,
  aExtendID, aDoorID, aType: string): string;
var
  stSql : string;
  TempAdoQuery :TADOQuery;
begin
  ...
  Try
    ...
    begin
      ...
      End;
      if recordCount < 1 then Exit;
      result := FindField('FN_DEVICEIP').AsString;
    end;
  Finally
    TempAdoQuery.EnableControls;
    TempAdoQuery.Free;
...
function TdmDBFunction.GetTB_FINGERDEVICE_FingerDeviceSeq(aNodeNo, aEcuID,
  aExtendID, aDoorID, aType: string): integer;
var
  stSql : string;
  TempAdoQuery :TADOQuery;
...
function TdmDBFunction.GetTB_FINGERDEVICE_FingerInfo(aFingerSeq: string;
  var aFingerID, aFingerIP, aFingerPort, aFingerName: string): Boolean;
var
  stSql : string;
  TempAdoQuery :TADOQuery;
begin
  ...
  Try
    ...
    begin
      ...
      if recordCount < 1 then Exit;
      result := True;
      aFingerID := FindField('FN_FINGERDEVICEID').AsString;
      aFingerIP := FindField('FN_DEVICEIP').AsString;
      aFingerPort := FindField('FN_DEVICEPORT').AsString;
      aFingerName := FindField('FN_DEVICENAME').AsString;
    end;
  Finally
    TempAdoQuery.EnableControls;
    TempAdoQuery.Free;
...
function TdmDBFunction.GetTB_LectureClassCode_AllName(aCode: string): string;
var
  len: integer;
  i : integer;
  stSql : string;
...
begin
  ...
  stSql := 'Select b.LC_CODENAME as NAME1 ';
  if len > 4 then  stSql := stSql +' ,c.LC_CODENAME as NAME2 ';
  if len > 7 then  stSql := stSql +' ,d.LC_CODENAME as NAME3 ';
  if len > 10 then  stSql := stSql +' ,e.LC_CODENAME as NAME4 ';
  if len > 13 then  stSql := stSql +' ,f.LC_CODENAME as NAME5 ';
  if len > 16 then  stSql := stSql +' ,g.LC_CODENAME as NAME6 ';
  if len > 19 then  stSql := stSql +' ,h.LC_CODENAME as NAME7 ';
  stSql := stSql + ' from (select * from TB_LectureClassCode where LC_CODE = ''' + aCode + ''') a ';
  stSql := stSql + ' Left Join TB_LectureClassCode b ';
  stSql := stSql + ' ON(substring(a.LC_CODE,1,4)=b.LC_CODE )';
  if(len>4) then
  begin
    stSql := stSql + ' Left Join TB_LectureClassCode c ';
    stSql := stSql + ' ON(substring(a.LC_CODE,1,7)=c.LC_CODE )';
  end;
  if(len>7) then
  begin
    stSql := stSql + ' Left Join TB_LectureClassCode d ';
    stSql := stSql + ' ON(substring(a.LC_CODE,1,10)=d.LC_CODE )';
  end;
  if(len>10) then
  begin
    stSql := stSql + ' Left Join TB_LectureClassCode e ';
    stSql := stSql + ' ON(substring(a.LC_CODE,1,13)=e.LC_CODE )';
  end;
  if(len>13) then
  begin
    stSql := stSql + ' Left Join TB_LectureClassCode f ';
    stSql := stSql + ' ON(substring(a.LC_CODE,1,16)=f.LC_CODE )';
  end;
  if(len>16) then
  begin
    stSql := stSql + ' Left Join TB_LectureClassCode g ';
    stSql := stSql + ' ON(substring(a.LC_CODE,1,19)=g.LC_CODE )';
  end;
  if(len>19) then
  begin
    stSql := stSql + ' Left Join TB_LectureClassCode h ';
    stSql := stSql + ' ON(substring(a.LC_CODE,1,22)=h.LC_CODE )';
  end;
  Try
    CoInitialize(nil);
    TempAdoQuery := TADOQuery.Create(nil);
    ...
    begin
      ...
      End;
      if recordcount < 1 then Exit;
      result := FindField('NAME1').AsString;
      if len > 4 then  result := result + '_' + FindField('NAME2').AsString;
      if len > 7 then  result := result + '_' + FindField('NAME3').AsString;
      if len > 10 then  result := result + '_' + FindField('NAME4').AsString;
      if len > 13 then  result := result + '_' + FindField('NAME5').AsString;
      if len > 16 then  result := result + '_' + FindField('NAME6').AsString;
      if len > 19 then  result := result + '_' + FindField('NAME7').AsString;
    end;
  Finally
    TempAdoQuery.EnableControls;
    TempAdoQuery.Free;
...
function TdmDBFunction.GetTB_LectureClassCode_CurrentDeepSeq(
  aOrgCode: string): string;
var
  stSql : string;
  TempAdoQuery : TADOQuery;
begin
  ...
  Try
    ...
    begin
      ...
      begin
        if G_bApplicationTerminate then Exit;
        result := FindField('LC_DEEPSEQ').AsString;
        Next;
      end;
    end;
  Finally
...
function TdmDBFunction.GetTB_LectureClassCode_ViewSeq(aCode: string): string;
var
  stSql : string;
  TempAdoQuery : TADOQuery;
begin
  ...
  Try
    ...
    begin
      ...
      begin
        if G_bApplicationTerminate then Exit;
        result := FindField('LC_VIEWSEQ').AsString;
        Next;
      end;
    end;
  Finally
...
function TdmDBFunction.GetTB_NODE_NodeAddr(aNodeNo: string): string;
var
  stSql : string;
  TempAdoQuery :TADOQuery;
begin
  ...
  Try
    ...
    begin
      ...
      End;
      if recordCount < 1 then Exit;
      result := FindField('ND_ADDR').AsString;
    end;
  Finally
    TempAdoQuery.EnableControls;
    TempAdoQuery.Free;
...
function TdmDBFunction.GetTB_ZONEEXTENTION_Type(aNodeNo, aEcuID,
  aExtendID: string): string;
var
  stSql : string;
  TempAdoQuery :TADOQuery;
begin
  ...
  Try
    ...
    begin
      ...
      End;
      if recordCount < 1 then Exit;
      result := FindField('ZE_TYPE').AsString;
    end;
  Finally
    TempAdoQuery.EnableControls;
    TempAdoQuery.Free;
...
function TdmDBFunction.GetTB_ZONE_ZoneName(aNodeNo, aECUID, aExtendID,
  aLoop: string): string;
var
  stSql : string;
  TempAdoQuery :TADOQuery;
begin
  ...
  stSql := stSql + ' AND DE_ECUID = ''' + aEcuID + ''' ';
  stSql := stSql + ' AND DE_EXTENDID = ' + aExtendID + ' ';
  stSql := stSql + ' AND ZN_ZONENO = ' + aLoop + ' ';
  ...
  Try
    ...
    begin
      ...
      End;
      if recordCount < 1 then Exit;
      result := FindField('ZN_ZONENAME').AsString;
    end;
  Finally
    TempAdoQuery.EnableControls;
    TempAdoQuery.Free;
