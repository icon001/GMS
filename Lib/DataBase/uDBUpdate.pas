...
uses
  System.SysUtils, System.Classes,JclMime;
...
type
  ...
  public
    { Public declarations }
    Function UpdateTB_ACademyAttend_Field_StringValue(aDate,aEmSeq,aFieldName,aData:string):Boolean;
    Function UpdateTB_ACademyAttendSummary_Field_IntValue(aDate,aEmSeq,aFieldName,aData:string):Boolean;
    Function UpdateTB_ACademyAttendSummary_Field_StringValue(aDate,aEmSeq,aFieldName,aData:string):Boolean;
    ...
    Function UpdateTB_ADMIN_PW(aUserID,aData:string):Boolean;
    ...
    Function UpdateTB_ALARMEVENTSTATEPCCODE_Field_StringValue(aCode,aFieldName,aData:string):Boolean;
    Function UpdateTB_ALARMEVENTSTATEPCCODE_Field_IntValue(aCode,aFieldName,aData:string):Boolean;
    Function UpdateTB_ARMAREA_DefaultNodeArmAreaName(aNodeNo,aNodeName:string;aBuildingcode:string=''):Boolean;
    ...
    Function UpdateTB_ATTENDFILEFORMAT_Field_IntValue(aSeq,aFieldName,aData:string):Boolean;
    Function UpdateTB_ATTENDFILEFORMAT_Field_StringValue(aSeq,aFieldName,aData:string):Boolean;
    ...
    Function UpdateTB_CARD_State_EmSeq(aEmSeq,aState:string):Boolean;
    ...
    Function UpdateTB_CARDGUBUN_Field_StringValue(aCode,aFieldName,aData:string):Boolean;
    ...
    Function UpdateTB_CARDPERMIT_EmSeqReSend(aEmSeq:string):Boolean;
    Function UpdateTB_CARDPERMIT_EmSeqStop(aEmSeq:string):Boolean;
    ...
    Function UpdateTB_CARDPERMITCOMPANYGROUP_LikeCompanyArmAreaPermitAdd(aCompanyCode, aNodeNo, aEcuID,aExtendID, aArmAreaNo:string):Boolean;
    Function UpdateTB_CARDPERMITCOMPANYGROUP_LikeCompanyArmAreaPermitDelete(aCompanyCode, aNodeNo, aEcuID,aExtendID, aArmAreaNo:string):Boolean;
    Function UpdateTB_CARDPERMITCOMPANYGROUP_LikeCompanyDoorPermitAdd(aCompanyCode, aNodeNo, aEcuID,aExtendID, aDoorNo:string):Boolean;
    Function UpdateTB_CARDPERMITCOMPANYGROUP_LikeCompanyDoorPermitDelete(aCompanyCode, aNodeNo, aEcuID,aExtendID, aDoorNo:string):Boolean;
    ...
    Function UpdateTB_CARDPERMITEMPLOYEECODE_EmSeqApplyNew(aEmSeq,aOldApply,aNewApply,aNodeNo,aEcuID:string):Boolean;
    ...
    Function UpdateTB_CARDPERMITEMPLOYEEGROUP_LikeEmGroupArmAreaPermitAdd(aEmGroupCode, aNodeNo, aEcuID,aExtendID, aArmAreaNo:string):Boolean;
    Function UpdateTB_CARDPERMITEMPLOYEEGROUP_LikeEmGroupArmAreaPermitDelete(aEmGroupCode, aNodeNo, aEcuID,aExtendID, aArmAreaNo:string):Boolean;
    Function UpdateTB_CARDPERMITEMPLOYEEGROUP_LikeEmGroupDoorPermitAdd(aEmGroupCode, aNodeNo, aEcuID,aExtendID, aDoorNo:string):Boolean;
    Function UpdateTB_CARDPERMITEMPLOYEEGROUP_LikeEmGroupDoorPermitDelete(aEmGroupCode, aNodeNo, aEcuID,aExtendID, aDoorNo:string):Boolean;
    Function UpdateTB_CCTV_Field_StringValue(aCCTVNo,aFieldName,aData:string):Boolean;
    Function UpdateTB_CERTIFICATEClassCode_Field_IntValue(aCode,aFieldName,aData:string):Boolean;
    Function UpdateTB_CERTIFICATEClassCode_Field_StringValue(aCode,aFieldName,aData:string):Boolean;
    Function UpdateTB_CERTIFICATEClassCode_ViewSeqUp(aViewSeq:string):Boolean;
    Function UpdateTB_CertificateCode_Value(aSeq,aName,aClassCode,aCertificateAmt,aOrganize,aIssuAmt,aMasterAmt,aHomePage:string):Boolean;
    Function UpdateTB_CertificateID_Value(aCertificateCode,aEmSeq,aCertificateID,aCertificatePW:string):Boolean;
    Function UpdateTB_CertificatePlan_Value(aCode,aDate,aSeq,aNewDate,aFromDate,aToDate,aResultDate:string):Boolean;
    Function UpdateTB_CertificateReceipt_Field_IntValue(aCode,aDate,aEmSeq,aFieldName,aData:string):Boolean;
    ...
    Function UpdateTB_CompanyCode_ViewSeqUp(aViewSeq:string):Boolean;
    Function UpdateTB_CONFIG_Field_StringValue(aGroup,aCode,aFieldName,aData:string):Boolean;
    Function UpdateTB_consultinggroupphonenum_Value(aPhone,aCgNum:string):Boolean;
    Function UpdateTB_consultinglist_Value(aSeq,aMemo:string):Boolean;
    Function UpdateTB_CurriculumCode_Value(aLectureSeq,aName,aLectureClassCode,aBookName,aBookAmt,aMonth,aGubun,aMainTeacher,aSubTeacher,aTime, aSun,aMon,aTue,aWed,aThu,aFri,aSat:string ):Boolean;
    Function UpdateTB_Decoder_Value(aDecoderNo,aServerName,aSocketType,aDecoderIP,aMonitoringServerPort,aControlerServerPort,aFTPPort,aDirectPort:string):Boolean;
    Function UpdateTB_DEVICE_DefaultNodeDeviceName(aNodeNo,aNodeName:string;aBuildingcode:string=''):Boolean;
    ...
    Function UpdateTB_DOOR_DefaultNodeDoorName(aNodeNo,aNodeName:string;aBuildingcode:string=''):Boolean;
    ...
    Function UpdateTB_EMPLOYEE_Academy(aEmSeq,aEmName,aCompanyCode,aGubunCode,aCompanyPhone,ahandPhone,aEmninfo,aBirthday,
    ...
    Function UpdateTB_EMPLOYEE_EmGradeTypeFromGroupCode(aEmGroupCode,aEmGradeType:string):Boolean;
    ...
    Function UpdateTB_EMPLOYEELecture_Field_IntValue(aEmSeq,aLectureSeq,aFieldName,aData:string):Boolean;
    Function UpdateTB_EMPLOYEELecture_Field_StringValue(aEmSeq,aLectureSeq,aFieldName,aData:string):Boolean;
    Function UpdateTB_EMPLOYEESTATECODE_Field_StringValue(aCode,aFieldName,aData:string):Boolean;
    Function UpdateTB_FINGERAPPROVALNUM_Field_StringValue(aFingerDeviceSeq,aFingerUserSeq,aFieldName,aData:string):Boolean;
    Function UpdateTB_FINGERDEVICE_IPID(aFingerSeq,aFingerIP,aFingerID:string):Boolean;
    Function UpdateTB_FINGERDEVICE_Value(aFnSeq,aDeviceIP,aDeviceName,aPort,aDeviceType,aCPType,aNodeNo,aEcuID,aExtendID,aDoorNo,aFingerDeviceID:string;aBuildingCode:string='0'):Boolean;
    Function UpdateTB_FINGERDEVICE_Field_StringValue(aFnSeq,aFieldName,aData:string):Boolean;
    Function UpdateTB_FINGERDEVICECARD_CardStop(aCardNo:string):Boolean;
    Function UpdateTB_FINGERDEVICECARD_EmSeqStop(aEmSeq:string):Boolean;
    Function UpdateTB_FINGERDEVICECARD_Field_StringValue(aFnSeq,aCardPOSITIONNUM,aFieldName,aData:string):Boolean;
    Function UpdateTB_FINGERDEVICECARD_CardResend(aPositionNum:string):Boolean;
    ...
    Function UpdateTB_LectureClassCode_Field_IntValue(aCode,aFieldName,aData:string):Boolean;
    Function UpdateTB_LectureClassCode_Field_StringValue(aCode,aFieldName,aData:string):Boolean;
    Function UpdateTB_LectureClassCode_ViewSeqUp(aViewSeq:string):Boolean;
    Function UpdateTB_LecturePaymentSummary_Field_IntValue(aPayMonth,aEMSeq,aFieldName,aData:string):Boolean;
    ...
    Function UpdateTB_TuitionOFFCode_Value(aCode,aName,aGubun,aValue:string):Boolean;
    Function UpdateTB_ZONE_DefaultNodeZoneName(aNodeNo,aNodeName:string;aBuildingcode:string=''):Boolean;
...
function TdmDBUpdate.UpdateTB_ACademyAttendSummary_Field_IntValue(aDate, aEmSeq,
  aFieldName, aData: string): Boolean;
var
  stSql : string;
begin
  stSql := 'Update TB_ACademyAttendSummary set ' + aFieldName + ' = ' + aData + ' ';
...
function TdmDBUpdate.UpdateTB_ACademyAttendSummary_Field_StringValue(aDate,
  aEmSeq, aFieldName, aData: string): Boolean;
var
  stSql : string;
begin
  stSql := 'Update TB_ACademyAttendSummary set ' + aFieldName + ' = ''' + aData + ''' ';
...
function TdmDBUpdate.UpdateTB_ACademyAttend_Field_StringValue(aDate, aEmSeq,
  aFieldName, aData: string): Boolean;
var
  stSql : string;
begin
  stSql := 'Update TB_ACademyAttend set ' + aFieldName + ' = ''' + aData + ''', ';
  stSql := stSql + 'AA_UpdateTime = ''' + FormatDateTime('yyyymmddhhnnsszzz',now) + ''' ';
...
function TdmDBUpdate.UpdateTB_ADMIN_PW(aUserID, aData: string): Boolean;
var
  stSql : string;
begin
  stSql := 'Update TB_ADMIN set AD_USERPW = ''' + aData + ''',AD_ENCODER = ''Y'' ';
  stSql := stSql + ' Where GROUP_CODE = ''' + G_stGroupCode + ''' ';
  stSql := stSql + ' AND AD_USERID = ''' + aUserID + ''' ';
  stSql := stSql + ' AND AD_ENCODER is null ';

  result := dmDataBase.ProcessExecSQL(stSql);

end;

function TdmDBUpdate.UpdateTB_ALARMEVENTSTATEPCCODE_Field_IntValue(aCode,
  aFieldName, aData: string): Boolean;
var
  stSql : string;
begin
  stSql := 'Update TB_ALARMEVENTSTATEPCCODE set ' + aFieldName + ' = ' + aData + ' ';
  stSql := stSql + ' Where GROUP_CODE = ''' + G_stGroupCode + ''' ';
  stSql := stSql + ' AND AP_EVENTSTATEPCCODE = ''' + aCode + ''' ';

  result := dmDataBase.ProcessExecSQL(stSql);

end;

function TdmDBUpdate.UpdateTB_ALARMEVENTSTATEPCCODE_Field_StringValue(aCode,
  aFieldName, aData: string): Boolean;
var
  stSql : string;
begin
...
begin
  ...
  stSql := stSql + ' Where GROUP_CODE = ''' + G_stGroupCode + ''' ';
  if aAlarmDate <> ''  then stSql := stSql + ' AND AE_DATE = ''' + aAlarmDate + ''' ';
  if aAlarmTime <> ''  then stSql := stSql + ' AND AE_TIME = ''' + aAlarmTime + ''' ';
  ...
  if aMsgNo <> ''  then stSql := stSql + ' AND AE_MSGNO = ''' + aMsgNo + ''' ';
...
function TdmDBUpdate.UpdateTB_ARMAREA_DefaultNodeArmAreaName(aNodeNo,
  aNodeName: string;aBuildingcode:string=''): Boolean;
var
  stSql : string;
begin
...
function TdmDBUpdate.UpdateTB_ATTENDFILEFORMAT_Field_IntValue(aSeq, aFieldName,
  aData: string): Boolean;
var
  stSql : string;
begin
  stSql := 'Update TB_ATTENDFILEFORMAT set ' + aFieldName + ' = ' + aData + ' ';
  stSql := stSql + ' Where GROUP_CODE = ''' + G_stGroupCode + ''' ';
  stSql := stSql + ' AND AF_SEQ = ''' + aSeq + ''' ';

  result := dmDataBase.ProcessExecSQL(stSql);

end;

function TdmDBUpdate.UpdateTB_ATTENDFILEFORMAT_Field_StringValue(aSeq,
  aFieldName, aData: string): Boolean;
var
  stSql : string;
begin
...
function TdmDBUpdate.UpdateTB_CARDGUBUN_Field_StringValue(aCode, aFieldName,
  aData: string): Boolean;
var
  stSql : string;
begin
  stSql := 'Update TB_CARDGUBUN set ' + aFieldName + ' = ''' + aData + ''' ';
  stSql := stSql + ' Where GROUP_CODE = ''' + G_stGroupCode + ''' ';
  stSql := stSql + ' AND CA_CARDGUBUN = ' + aCode + ' ';
...
function TdmDBUpdate.UpdateTB_CARDPERMITCOMPANYGROUP_LikeCompanyArmAreaPermitAdd(
  aCompanyCode, aNodeNo, aEcuID, aExtendID, aArmAreaNo: string): Boolean;
var
  stSql : string;
begin
  stSql := 'Update TB_CARDPERMITCOMPANYGROUP set CP_APPLY = ''N'', ';
  stSql := stSql + ' CP_PERMIT = ''1'' ';
  stSql := stSql + ' Where GROUP_CODE = ''' + G_stGroupCode + ''' ';
  stSql := stSql + ' AND CO_COMPANYCODE Like ''' + aCompanyCode + '%'' ';
  ...
  stSql := stSql + ' AND DE_ECUID = ''' + aEcuID + ''' ';
  stSql := stSql + ' AND DE_EXTENDID = ' + aExtendID + ' ';
  stSql := stSql + ' AND CP_TYPE = ''2'' ';
  stSql := stSql + ' AND CP_NUMBER = ' + aArmAreaNo + ' ';

  result := dmDataBase.ProcessExecSQL(stSql);
end;

function TdmDBUpdate.UpdateTB_CARDPERMITCOMPANYGROUP_LikeCompanyArmAreaPermitDelete(
  aCompanyCode, aNodeNo, aEcuID, aExtendID, aArmAreaNo: string): Boolean;
var
  stSql : string;
begin
...
function TdmDBUpdate.UpdateTB_CARDPERMITCOMPANYGROUP_LikeCompanyDoorPermitAdd(
...
function TdmDBUpdate.UpdateTB_CARDPERMITCOMPANYGROUP_LikeCompanyDoorPermitDelete(
  aCompanyCode, aNodeNo, aEcuID, aExtendID, aDoorNo: string): Boolean;
var
  stSql : string;
begin
...
function TdmDBUpdate.UpdateTB_CARDPERMITEMPLOYEECODE_EmSeqApplyNew(aEmSeq,
  aOldApply, aNewApply,aNodeNo,aEcuID: string): Boolean;
var
  stSql : string;
begin
  stSql := 'Update TB_CARDPERMITEMPLOYEECODE set ';
...
function TdmDBUpdate.UpdateTB_CARDPERMITEMPLOYEEGROUP_LikeEmGroupArmAreaPermitAdd(
  aEmGroupCode, aNodeNo, aEcuID, aExtendID, aArmAreaNo: string): Boolean;
var
  stSql : string;
begin
  stSql := 'Update TB_CARDPERMITEMPLOYEEGROUP set CP_APPLY = ''N'', ';
  stSql := stSql + ' CP_PERMIT = ''1'' ';
  stSql := stSql + ' Where GROUP_CODE = ''' + G_stGroupCode + ''' ';
  stSql := stSql + ' AND EM_GROUPCODE Like ''' + aEmGroupCode + '%'' ';
  stSql := stSql + ' AND CP_PERMIT <> ''1'' ';
...
function TdmDBUpdate.UpdateTB_CARDPERMITEMPLOYEEGROUP_LikeEmGroupArmAreaPermitDelete(
  aEmGroupCode, aNodeNo, aEcuID, aExtendID, aArmAreaNo: string): Boolean;
var
  stSql : string;
begin
...
function TdmDBUpdate.UpdateTB_CARDPERMITEMPLOYEEGROUP_LikeEmGroupDoorPermitAdd(
...
function TdmDBUpdate.UpdateTB_CARDPERMITEMPLOYEEGROUP_LikeEmGroupDoorPermitDelete(
  aEmGroupCode, aNodeNo, aEcuID, aExtendID, aDoorNo: string): Boolean;
var
  stSql : string;
begin
...
function TdmDBUpdate.UpdateTB_CARDPERMIT_EmSeqReSend(aEmSeq: string): Boolean;
var
  stSql : string;
begin
  stSql := ' Update A Set ';
  stSql := stSql + ' a.CP_RCVACK = ''N'' ';
  stSql := stSql + ' From TB_CARDPERMIT A,';
  stSql := stSql + ' TB_CARD B ';
...
function TdmDBUpdate.UpdateTB_CARDPERMIT_EmSeqStop(aEmSeq: string): Boolean;
var
  stSql : string;
begin
  stSql := ' Update A Set ';
  stSql := stSql + ' a.CP_PERMIT = ''0'' ,';
  stSql := stSql + ' a.CP_MEMLOAD = ''N'', ';
  stSql := stSql + ' a.CP_RCVACK = ''N'' ';
  stSql := stSql + ' From TB_CARDPERMIT A,';
  stSql := stSql + ' TB_CARD B ';
  stSql := stSql + ' WHERE a.CA_CARDNO = b.CA_CARDNO ';
...
function TdmDBUpdate.UpdateTB_CARD_State_EmSeq(aEmSeq, aState: string): Boolean;
var
  stSql : string;
begin
  stSql := ' Update TB_CARD Set CA_STATECODE = ''' + aState + ''' ';
...
function TdmDBUpdate.UpdateTB_CERTIFICATEClassCode_Field_IntValue(aCode,
  aFieldName, aData: string): Boolean;
var
  stSql : string;
begin
  stSql := 'Update TB_CERTIFICATECLASSCODE set ' + aFieldName + ' = ' + aData + ' ';
  stSql := stSql + ' Where GROUP_CODE = ''' + G_stGroupCode + ''' ';
...
function TdmDBUpdate.UpdateTB_CERTIFICATEClassCode_Field_StringValue(aCode,
  aFieldName, aData: string): Boolean;
var
  stSql : string;
begin
  if Uppercase(aFieldName) = 'CC_CODENAME' then stSql := 'Update TB_CERTIFICATECLASSCODE set ' + aFieldName + ' = N''' + aData + ''' '
  else stSql := 'Update TB_CERTIFICATECLASSCODE set ' + aFieldName + ' = ''' + aData + ''' ';
  stSql := stSql + ' Where GROUP_CODE = ''' + G_stGroupCode + ''' ';
  stSql := stSql + ' AND CC_CODE = ''' + aCode + ''' ';
...
function TdmDBUpdate.UpdateTB_CERTIFICATEClassCode_ViewSeqUp(
  aViewSeq: string): Boolean;
var
  stSql : string;
begin
  stSql := 'Update TB_CERTIFICATEClassCode set CC_VIEWSEQ = CC_VIEWSEQ + 1 ';
  stSql := stSql + ' Where GROUP_CODE = ''' + G_stGroupCode + ''' ';
  stSql := stSql + ' AND CC_VIEWSEQ >= ' + aViewSeq + ' ';
  stSql := stSql + ' AND CC_CODE <> ''0'' ';

  result := dmDataBase.ProcessExecSQL(stSql);
end;

function TdmDBUpdate.UpdateTB_CertificateCode_Value(aSeq, aName, aClassCode,
  aCertificateAmt, aOrganize, aIssuAmt, aMasterAmt,aHomePage: string): Boolean;
var
  stSql : string;
begin
  ...
  stSql := 'Update TB_CertificateCode Set ';
  stSql := stSql + ' CF_NAME = N''' + aName + ''', ';
  stSql := stSql + ' CC_CODE = ''' + aClassCode + ''', ';
  stSql := stSql + ' CF_AMT = ' + aCertificateAmt + ', ';
  stSql := stSql + ' CF_ORGANIZER = ''' + aOrganize + ''',';
  stSql := stSql + ' CF_CERTIISSUAMT =' + aIssuAmt + ',';
  stSql := stSql + ' CF_MASTERAMT = ' + aMasterAmt + ', ';
  stSql := stSql + ' CF_HOMEPAGE = ''' + aHomePage + ''' ';
  stSql := stSql + ' Where GROUP_CODE = ''' + G_stGroupCode + ''' ';
  stSql := stSql + ' AND CF_CODE = ' + aSeq + ' ';

  result := dmDataBase.ProcessExecSQL(stSql);

end;

function TdmDBUpdate.UpdateTB_CertificateID_Value(aCertificateCode, aEmSeq,
  aCertificateID, aCertificatePW: string): Boolean;
var
  stSql : string;
begin
  stSql := 'Update TB_CertificateID set ';
  stSql := stSql + ' CI_ID = ''' + aCertificateID + ''', ';
  stSql := stSql + ' CI_PW = ''' + aCertificatePW + ''' ';
  stSql := stSql + ' Where GROUP_CODE = ''' + G_stGroupCode + ''' ';
  stSql := stSql + ' AND CF_CODE = ' + aCertificateCode + ' ';
  stSql := stSql + ' AND EM_SEQ = ' + aEmSeq + ' ';

  result := dmDataBase.ProcessExecSQL(stSql);
end;

function TdmDBUpdate.UpdateTB_CertificatePlan_Value(aCode, aDate, aSeq,aNewDate,
  aFromDate, aToDate, aResultDate: string): Boolean;
var
  stSql : string;
begin
  stSql := 'update TB_CertificatePlan set ';
  stSql := stSql + ' CP_DATE = ''' + aNewDate + ''', ';
  stSql := stSql + ' CP_SEQ = ' + aSeq + ', ';
  stSql := stSql + ' CP_RECEIPTFROM = ''' + aFromDate + ''', ';
  stSql := stSql + ' CP_RECEIPTTO = ''' + aToDate + ''',';
  stSql := stSql + ' CP_RESULTDATE = ''' + aResultDate + ''' ';
  stSql := stSql + ' Where GROUP_CODE = ''' + G_stGroupCode + ''' ';
...
function TdmDBUpdate.UpdateTB_CertificateReceipt_Field_IntValue(aCode, aDate,
  aEmSeq, aFieldName, aData: string): Boolean;
var
  stSql : string;
begin
  stSql := 'Update TB_CertificateReceipt set ' + aFieldName + ' = ' + aData + ' ';
  stSql := stSql + ' Where GROUP_CODE = ''' + G_stGroupCode + ''' ';
  stSql := stSql + ' AND CF_CODE = ' + aCode + ' ';
  stSql := stSql + ' AND CP_DATE = ''' + aDate + ''' ';
  stSql := stSql + ' AND EM_SEQ = ' + aEmSeq + ' ';
...
function TdmDBUpdate.UpdateTB_CompanyCode_ViewSeqUp(aViewSeq: string): Boolean;
var
  stSql : string;
begin
  stSql := 'Update TB_COMPANYCODE set CO_VIEWSEQ = CO_VIEWSEQ + 1 ';
  stSql := stSql + ' Where GROUP_CODE = ''' + G_stGroupCode + ''' ';
  stSql := stSql + ' AND CO_VIEWSEQ >= ' + aViewSeq + ' ';
  stSql := stSql + ' AND CO_COMPANYCODE <> ''0'' ';
...
function TdmDBUpdate.UpdateTB_consultinggroupphonenum_Value(aPhone,
  aCgNum: string): Boolean;
var
  stSql : string;
begin
  stSql := 'Update TB_consultinggroupphonenum set ';
  stSql := stSql + ' cg_num = ' + aCgNum + ' ';
  stSql := stSql + ' Where cg_phonenumber = ''' + aPhone + ''' ';

  result := dmDataBase.ProcessExecSQL(stSql);

end;

function TdmDBUpdate.UpdateTB_consultinglist_Value(aSeq,
  aMemo: string): Boolean;
var
  stSql : string;
begin
  stSql := 'Update TB_consultinglist set ';
  stSql := stSql + ' cg_memo = ''' + aMemo + ''' ';
  stSql := stSql + ' Where cg_seq = ' + aSeq + ' ';

  result := dmDataBase.ProcessExecSQL(stSql);
end;

function TdmDBUpdate.UpdateTB_CurriculumCode_Value(aLectureSeq, aName,
  aLectureClassCode, aBookName, aBookAmt, aMonth, aGubun, aMainTeacher,
  aSubTeacher, aTime,  aSun,aMon,aTue,aWed,aThu,aFri,aSat: string): Boolean;
var
  stSql : string;
begin
  stSql := 'Update TB_CurriculumCode set ';
  stSql := stSql + ' CC_NAME = N''' + aName + ''', ';
  stSql := stSql + ' LC_CODE = ''' + aLectureClassCode + ''', ';
  stSql := stSql + ' CC_BOOKNAME = N''' + aBookName + ''', ';
  stSql := stSql + ' CC_BOOKAMT = ' + aBookAmt + ', ';
  stSql := stSql + ' CC_MONTH = ' + aMonth + ', ';
  stSql := stSql + ' CC_GUBUN = ' + aGubun + ', ';
  stSql := stSql + ' AD_USERID = ''' + aMainTeacher + ''', ';
  stSql := stSql + ' AD_SUBUSERID = ''' + aSubTeacher + ''', ';
  stSql := stSql + ' CC_HH = ' + aTime + ', ';
  stSql := stSql + ' CC_SUN = ''' + aSun + ''', ';
  stSql := stSql + ' CC_MON = ''' + aMon + ''', ';
  stSql := stSql + ' CC_TUE = ''' + aTue + ''', ';
  stSql := stSql + ' CC_WED = ''' + aWed + ''', ';
  stSql := stSql + ' CC_THU = ''' + aThu + ''', ';
  stSql := stSql + ' CC_FRI = ''' + aFri + ''', ';
  stSql := stSql + ' CC_SAT = ''' + aSat + '''  ';
  stSql := stSql + ' Where GROUP_CODE = ''' + G_stGroupCode + ''' ';
...
function TdmDBUpdate.UpdateTB_Decoder_Value(aDecoderNo, aServerName,
  ...
  aControlerServerPort,aFTPPort,aDirectPort: string): Boolean;
var
  stSql : string;
begin
  ...
  stSql := stSql + ' ND_DIRECTPORT = ' + aDirectPort + ' ';
  stSql := stSql + ' Where GROUP_CODE = ''' + G_stGroupCode + ''' ';
...
function TdmDBUpdate.UpdateTB_EMPLOYEELecture_Field_IntValue(aEmSeq,
  aLectureSeq, aFieldName, aData: string): Boolean;
var
  stSql : string;
begin
  stSql := 'Update TB_EMPLOYEELecture set ' + aFieldName + ' = ' + aData + ' ';
  stSql := stSql + ' Where EM_SEQ = ' + aEmSeq + ' ';
  stSql := stSql + ' AND CC_CODE = ' + aLectureSeq + ' ';
...
function TdmDBUpdate.UpdateTB_EMPLOYEELecture_Field_StringValue(aEmSeq,
  aLectureSeq, aFieldName, aData: string): Boolean;
var
  stSql : string;
begin
...
function TdmDBUpdate.UpdateTB_EMPLOYEESTATECODE_Field_StringValue(aCode,
  aFieldName, aData: string): Boolean;
var
  stSql : string;
begin
  stSql := 'Update TB_EMPLOYEESTATECODE set ' + aFieldName + ' = ''' + aData + ''' ';
  stSql := stSql + ' Where EM_STATECODE = ' + aCode + ' ';

  result := dmDataBase.ProcessExecSQL(stSql);

end;

function TdmDBUpdate.UpdateTB_EMPLOYEE_Academy(aEmSeq, aEmName, aCompanyCode,
  aGubunCode, aCompanyPhone, ahandPhone, aEmninfo, aBirthday, aRegDate,
  aEndDate, aACType, aATType, aFdType, aEmGroupCode, aGradeType, aFingerUse,
  aEmStateCode, aAWCode, aCardUse, aEmail, aSchoolName, aGrade,
...
begin
  ...
  stSql := stSql + ', EM_BIRTHDAY = ''' + aBirthday + ''' ';
  stSql := stSql + ', EM_EMAIL = ''' + aEmail + ''' ';
  stSql := stSql + ', EM_SCHOOL = ''' + aSchoolName + ''' ';
  stSql := stSql + ', EM_GRADE = ''' + aGrade + ''' ';
  stSql := stSql + ', TO_CODE = ' + aTuitionOFF + ' ';
  stSql := stSql + ', EM_PAYMENTDAY = ' + aPaymentday + ' ';
  stSql := stSql + ', CG_NUM = ' + aCgNum + ' ';
  stSql := stSql + ', EM_KEY = ''' + MimeEncodeString(aKey) + ''' ';
  stSql := stSql + ', EM_ACMON = ''' + aMon + ''' ';
  stSql := stSql + ', EM_ACTUE = ''' + aTue + ''' ';
  stSql := stSql + ', EM_ACWED = ''' + aWed + ''' ';
  stSql := stSql + ', EM_ACTHU = ''' + aThu + ''' ';
  stSql := stSql + ', EM_ACFRI = ''' + aFri + ''' ';
  stSql := stSql + ', EM_ACSAT = ''' + aSat + ''' ';
  stSql := stSql + ', EM_ACSUN = ''' + aSun + ''' ';
  stSql := stSql + ' Where EM_SEQ = ' + aEmSeq + ' ';
...
function TdmDBUpdate.UpdateTB_EMPLOYEE_EmGradeTypeFromGroupCode(aEmGroupCode,
  aEmGradeType: string): Boolean;
var
  stSql : string;
begin
  stSql := 'Update TB_EMPLOYEE set EM_GRADETYPE = ' + aEmGradeType + ' ';
...
function TdmDBUpdate.UpdateTB_FINGERAPPROVALNUM_Field_StringValue(aFingerDeviceSeq,
  aFingerUserSeq, aFieldName, aData: string): Boolean;
var
  stSql : string;
begin
  stSql := 'Update TB_FINGERAPPROVALNUM set ' + aFieldName + ' = ''' + aData + ''' ';
  stSql := stSql + ' Where FN_DEVICESEQ = ' + aFingerDeviceSeq + ' ';
  stSql := stSql + ' AND CA_POSITIONNUM = ' + aFingerUserSeq + ' ';

  result := dmDataBase.ProcessExecSQL(stSql);
end;

function TdmDBUpdate.UpdateTB_FINGERDEVICECARD_CardResend(
...
function TdmDBUpdate.UpdateTB_FINGERDEVICECARD_CardStop(
  aCardNo: string): Boolean;
var
  stSql : string;
begin
  stSql := 'Update TB_FINGERDEVICECARD set CP_PERMIT = ''0'',FD_SEND=''N'' ';
  stSql := stSql + ' FROM TB_FINGERDEVICECARD A ';
  stSql := stSql + ' JOIN TB_CARD B ON(A.CA_POSITIONNUM=B.CA_POSITIONNUM AND B.CA_CARDNO = ''' + aCardNo + ''' ';

  result := dmDataBase.ProcessExecSQL(stSql);
end;

function TdmDBUpdate.UpdateTB_FINGERDEVICECARD_EmSeqStop(
...
function TdmDBUpdate.UpdateTB_FINGERDEVICE_Field_StringValue(aFnSeq, aFieldName,
  aData: string): Boolean;
var
  stSql : string;
begin
  stSql := 'Update TB_FINGERDEVICE set ' + aFieldName + ' = ''' + aData + ''' ';
  stSql := stSql + ' Where GROUP_CODE = ''' + G_stGroupCode + ''' ';
  stSql := stSql + ' AND FN_DEVICESEQ = ' + aFnSeq + ' ';
...
function TdmDBUpdate.UpdateTB_FINGERDEVICE_IPID(aFingerSeq, aFingerIP,
  aFingerID: string): Boolean;
var
  stSql : string;
begin
  stSql := 'Update TB_FINGERDEVICE set ';
  stSql := stSql + ' FN_DEVICEIP = ''' + aFingerIP + ''',';
  stSql := stSql + ' FN_FINGERDEVICEID = ' + aFingerID + ', ';
  stSql := stSql + ' FN_CHANGE = ''Y'' ';
  stSql := stSql + ' Where GROUP_CODE = ''' + G_stGroupCode + ''' ';
...
begin
  ...
  stSql := stSql + ' DE_EXTENDID = ' + aExtendID + ',';
  stSql := stSql + ' DO_DOORNO = ' + aDoorNo + ', ';
  stSql := stSql + ' FN_FINGERDEVICEID = ' + aFingerDeviceID + ', ';
...
function TdmDBUpdate.UpdateTB_LectureClassCode_Field_IntValue(aCode, aFieldName,
  aData: string): Boolean;
var
  stSql : string;
begin
  stSql := 'Update TB_LectureClassCode set ' + aFieldName + ' = ' + aData + ' ';
  stSql := stSql + ' Where GROUP_CODE = ''' + G_stGroupCode + ''' ';
...
function TdmDBUpdate.UpdateTB_LectureClassCode_Field_StringValue(aCode,
  aFieldName, aData: string): Boolean;
var
  stSql : string;
begin
  if Uppercase(aFieldName) = 'LC_CODENAME' then stSql := 'Update TB_LectureClassCode set ' + aFieldName + ' = N''' + aData + ''' '
  else stSql := 'Update TB_LectureClassCode set ' + aFieldName + ' = ''' + aData + ''' ';
  stSql := stSql + ' Where GROUP_CODE = ''' + G_stGroupCode + ''' ';
  stSql := stSql + ' AND LC_CODE = ''' + aCode + ''' ';
...
function TdmDBUpdate.UpdateTB_LectureClassCode_ViewSeqUp(
  aViewSeq: string): Boolean;
var
  stSql : string;
begin
  stSql := 'Update TB_LectureClassCode set LC_VIEWSEQ = LC_VIEWSEQ + 1 ';
  stSql := stSql + ' Where GROUP_CODE = ''' + G_stGroupCode + ''' ';
  stSql := stSql + ' AND LC_VIEWSEQ >= ' + aViewSeq + ' ';
  stSql := stSql + ' AND LC_CODE <> ''0'' ';

  result := dmDataBase.ProcessExecSQL(stSql);

end;

function TdmDBUpdate.UpdateTB_LecturePaymentSummary_Field_IntValue(aPayMonth,
  aEMSeq, aFieldName, aData: string): Boolean;
var
  stSql : string;
begin
  stSql := 'Update TB_LecturePaymentSummary set ' + aFieldName + ' = ' + aData + ' ';
  stSql := stSql + ' Where GROUP_CODE = ''' + G_stGroupCode + ''' ';
  stSql := stSql + ' AND LP_MONTH = ''' + aPayMonth + ''' ';
  stSql := stSql + ' AND EM_SEQ = ' + aEMSeq + ' ';
...
function TdmDBUpdate.UpdateTB_TuitionOFFCode_Value(aCode, aName, aGubun,
  aValue: string): Boolean;
var
  stSql : string;
begin
  stSql := 'Update TB_TuitionOFF set TO_NAME = ''' + aName + ''', ';
  stSql := stSql + 'TO_GUBUN = ' + aGubun + ', ';
  stSql := stSql + 'TO_VALUE = ' + aValue + ' ';
  stSql := stSql + ' Where GROUP_CODE = ''' + G_stGroupCode + ''' ';
