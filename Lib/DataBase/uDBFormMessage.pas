...
type
  ...
  private
    ...
    function MessageTable_0007_VersionMake:Boolean;
  public
    { Public declarations }
...
begin
  ...
  if nTableVersion < 6 then MessageTable_0006_VersionMake;
  if nTableVersion < 7 then MessageTable_0007_VersionMake;
...
function TdmFormMessage.MessageTable_0007_VersionMake: Boolean;
begin
  dmDBInsert.InsertIntoTB_FORMMESSAGE_All('FINGERDELETE','지문정보를 삭제하시겠습니까?','DataBase Finger Information?');

  dmDBUpdate.UpdateTB_CONFIG_Field_StringValue('COMMON','FORMMESSAGE_VER','CO_CONFIGVALUE','7');
