...
type
  ...
  public
    { Public declarations }
    Function DeleteTB_AcademySMSSend_EMSEQ(aDate,aEmSeq,aGubun,aAtGubun:string):Boolean;
    ...
    Function DeleteTB_CARDGUBUN_Key(aKey:string):Boolean;
    ...
    Function DeleteTB_CERTIFICATECLASSCODE_LikeCode(aCode:string):Boolean;
    Function DeleteTB_CertificateCode_Key(aSeq:string):Boolean;
    Function DeleteTB_CertificateID_Key(aCeritficateCode,aEmSeq:string):Boolean;
    Function DeleteTB_CertificatePlan_Key(aCode,aDate:string):Boolean;
    ...
    Function DeleteTB_DEVICE_Extend(aNodeNo,aEcuID,aExtendID:string):Boolean;
    Function DeleteTB_DEVICE_NodeAll(aNodeNo:string):Boolean;
    Function DeleteTB_DEVICERCV_ECUAll(aNodeNo,aEcuID:string):Boolean;
    Function DeleteTB_DEVICERCV_Extend(aNodeNo,aEcuID,aExtendID:string):Boolean;
...
function TdmDBDelete.DeleteTB_AcademySMSSend_EMSEQ(aDate, aEmSeq, aGubun,
  aAtGubun: string): Boolean;
var
  stSql : string;
begin
  stSql := ' Delete From TB_AcademySMSSend ';
...
function TdmDBDelete.DeleteTB_CARDGUBUN_Key(aKey: string): Boolean;
var
  stSql : string;
begin
  stSql := ' Delete From TB_CARDGUBUN ';
  stSql := stSql + ' Where GROUP_CODE = ''' + G_stGroupCode + ''' ';
  stSql := stSql + ' AND CA_CARDGUBUN = ' + aKey + ' ';
...
function TdmDBDelete.DeleteTB_CERTIFICATECLASSCODE_LikeCode(
  aCode: string): Boolean;
var
  stSql : string;
begin
  stSql := ' Delete From TB_CERTIFICATECLASSCODE ';
  stSql := stSql + ' Where GROUP_CODE = ''' + G_stGroupCode + ''' ';
...
function TdmDBDelete.DeleteTB_CertificateCode_Key(aSeq: string): Boolean;
var
  stSql : string;
begin
  stSql := ' Delete From TB_CertificateCode ';
  stSql := stSql + ' Where GROUP_CODE = ''' + G_stGroupCode + ''' ';
...
function TdmDBDelete.DeleteTB_CertificateID_Key(aCeritficateCode,
  aEmSeq: string): Boolean;
var
  stSql : string;
begin
  stSql := ' Delete From TB_CertificateID ';
  stSql := stSql + ' Where CF_CODE = ' + aCeritficateCode + ' ';
  stSql := stSql + ' AND EM_SEQ = ' + aEmSeq + ' ';
...
function TdmDBDelete.DeleteTB_CertificatePlan_Key(aCode,
  aDate: string): Boolean;
var
  stSql : string;
begin
  stSql := ' Delete From TB_CertificatePlan ';
  stSql := stSql + ' Where GROUP_CODE = ''' + G_stGroupCode + ''' ';
...
function TdmDBDelete.DeleteTB_DEVICERCV_Extend(aNodeNo, aEcuID,
...
function TdmDBDelete.DeleteTB_DEVICE_Extend(aNodeNo, aEcuID,
  aExtendID: string): Boolean;
var
  stSql : string;
begin
