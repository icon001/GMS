...
const
    ...
    con_DeviceCmdFTPCardDownLoadPer = 37;   //FTP 카드 다운로드 게이지
    con_DeviceCmdJaeJungDelaySkill = 38;
    con_DeviceCmdJaeJungDelayUse = 39;
    con_DeviceCmdJAVARAARMCLOSE = 40;
    con_DeviceCmdJAVARAAUTOCLOSE = 41;
    con_DeviceCmdJAVARADISARMOPEN = 42;
    con_DeviceCmdJAVARASERVERARMCLOSE = 43;
    con_DeviceCmdJAVARASERVERDISARMOPEN = 44;
    con_DeviceCmdJAVARATYPEUSE = 45;
    con_DeviceCmdKttCDMACHECKTIME = 46;
    con_DeviceCmdKttCDMADATA = 47;
    con_DeviceCmdKttCDMAIP = 48;
    con_DeviceCmdKTTCDMAMIN = 49;
    con_DeviceCmdKttCDMAMUX = 50;
    con_DeviceCmdKttCDMAPORT = 55;
    con_DeviceCmdKttCDMARSSI = 56;
    con_DeviceCmdKttCdmaUse = 57;
    con_DeviceCmdKTTREMOTEARMRINGCOUNT = 58;
    con_DeviceCmdKTTREMOTEDisARMRINGCOUNT = 59;
    con_DeviceCmdKTTSystemID = 60;
    con_DeviceCmdKTTTelNumber1 = 61;
    con_DeviceCmdKTTTelNumber2 = 62;
    con_DeviceCmdLAMPONTIME = 63;
    con_DeviceCmdNetworkState = 64;
    con_DeviceCmdSIRENONTIME = 65;
    con_DeviceCmdSystemInformation = 66;
    con_DeviceCmdTimeCodeSend = 67;
    con_DeviceCmdTimeCodeSkill = 68;
    con_DeviceCmdTimeCodeUse = 70;
    con_DeviceCmdType = 71;
    con_DeviceCmdUseState = 72;
    con_DeviceCmdVER = 73;
    con_DeviceCmdWATCHACPOWER = 74;
    con_DeviceCmdZoneExtentionCount = 75;
    con_DeviceControlTimeSync = 76;             //제어 시간동기화
    con_DeviceDoorStateRCV = 77;
...
//출입문 이벤트
    ...
    con_DoorCurrentFireEvent = 83; //현재 화재 발생 유무
    con_DoorCurrentManagerMode = 84; //현재 운영모드
    con_DoorCurrentRcvState = 85;  //현재 상태 수신 유무
...
//방범구역 이벤트
    ...
    con_ArmAreaCmdModeChange = 2;
    con_ArmAreaCmdUse = 10;
    con_ArmAreaCmdView = 11;
...
const
  con_cmdManagerToServerFormShow = 0;
  con_cmdManagerToServerAccessEvent = 1;
  con_cmdManagerToServerACK = 2;
  con_cmdManagerToServerAlarmEvent = 3;
  con_cmdManagerToServerCardFTP = 4;    //즉시전송
  con_cmdManagerToServerCardSend = 5;    //즉시전송
  con_cmdManagerToServerCardUpdate = 6;  //변경
  con_cmdManagerToServerDeviceHoliday = 10;        //공휴일 전송
  con_cmdManagerToServerDeviceArmAreaUseChange = 11;        //컨트롤러 방범구역사용유무 변경
  con_cmdManagerToServerDeviceChange = 12;      //컨트롤러 교체에 따른 재 로딩..기기코드,기기버젼
  con_cmdManagerToServerDoorMemLoadChange = 20;
  con_cmdManagerToServerDoorOpen = 21;
  con_cmdManagerToServerDoorScheduleChange = 22;   //출입문스케줄 변경
  con_cmdManagerToServerDoorSettingRegist = 23;    //출입문 설정 정보 셋팅
  con_cmdManagerToServerDoorSettingSearch = 24;    //출입문 설정 정보 조회
  con_cmdManagerToServerDoorTimeCodeUseChange = 25; //출입문 타임코드 사용유무 변경
  con_cmdManagerToServerNodeChange = 30;        //노드 변경
  con_cmdManagerToServerReaderTelNumber = 40;  //카드리더전화번호변경
  con_cmdManagerToServerTimeDeviceCodeChange=50;   //타임코드 변경
...
type
  ...
  TCardPermitProgress = procedure(Sender: TObject; aType,aCode:string;aTotCount,aCurCount:integer) of object;
  TCardRcvPacket = procedure(Sender: TObject;  aNodeNo : integer;aEcuID,aCardNo,aRcvAck:string;aPermit:Boolean) of object;
