...
const
  ...
  con_cmdManagerToServerDoorScheduleChange = 21;   //출입문스케줄 변경
  con_cmdManagerToServerDoorSettingRegist = 22;    //출입문 설정 정보 셋팅
  con_cmdManagerToServerDoorSettingSearch = 23;    //출입문 설정 정보 조회
  con_cmdManagerToServerDoorTimeCodeUseChange = 24; //출입문 타임코드 사용유무 변경
