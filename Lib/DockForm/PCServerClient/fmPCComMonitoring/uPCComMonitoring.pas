...
uses
  ...
  Vcl.Imaging.pngimage, AdvOfficePagerStylers,Vcl.Clipbrd;
...
type
  ...
  public
    ...
    procedure ClientPacketView(aTxRx,aClientIP,aData,aResult:string);   //PC Packet
...
procedure TfmPCComMonitoring.ClientPacketView(aTxRx, aClientIP, aData,
  aResult: string);
begin
...
procedure TfmPCComMonitoring.sg_ComMonitoringKeyDown(Sender: TObject;
