...
begin
  ...
  Try
    ...
    begin
      ...
      if Not G_bIsMaster then
      begin
        if aBuildingCode = '0' then //전체 조회시
        begin
          bFirst := False;
          arrNode[nViewDeepSeq] := aTreeView.Items.Add(nil,'전체');
      ...
      begin
        ...
        begin
          ...
          if aNode = nil then
          begin
            if Not G_bIsMaster and (aBuildingCode = '0') then     //전체 안에 넣자
            begin
              nViewDeepSeq := 1;
...
begin
  ...
  Try
    ...
    begin
      ...
      While Not Eof do
      begin
        cmb_Box.Items.Add(MakeDateTimeStr(FindField('CP_DATE').AsString) + '-' + FindField('CP_SEQ').AsString + '회');
      ...
      begin
        Try
          ...
          begin
            ...
            if aNode = nil then
            begin
              if Not G_bIsMaster and (aCompanyCode = '0') then     //전체 안에 넣자
              begin
                nNodeDeepSeq := 1;
    ...
    begin
      ...
      begin
        ...
        begin
          ...
          if aNode = nil then
          begin
            if Not G_bIsMaster and (aEmGroupCode = '0') then     //전체 안에 넣자
            begin
              nViewDeepSeq := 1;
