...
type
  TdmKTAMSDataBase = class(TDataModule)
...
var
  dmKTAMSDataBase: TdmKTAMSDataBase;
...
function TdmKTAMSDataBase.AlterTB_SLOCAL_RelayBuildingCode_Add: Boolean;
var
  stSql : string;
begin
...
function TdmKTAMSDataBase.AlterTB_SLOCAL_RelayCode_Add: Boolean;
var
  stSql : string;
begin
...
function TdmKTAMSDataBase.CheckTB_LOCAL_Code(aLocalCode: string): integer;
var
  stSql : string;
...
function TdmKTAMSDataBase.DataBaseConnect(aDBType: integer; aDBHost, aDBPort,
...
function TdmKTAMSDataBase.DataBaseDisConnect: Boolean;
begin
  DBConnected := False;
  with ADOConnection do
  begin
...
procedure TdmKTAMSDataBase.DataModuleCreate(Sender: TObject);
begin
  DBConnected := False;
end;

function TdmKTAMSDataBase.GetTableVersion: integer;
var
  stSql : string;
begin
  result := 0;
...
function TdmKTAMSDataBase.GetTB_SLOCAL_BuildingCode(aCode: string;
...
function TdmKTAMSDataBase.GetTB_SLOCAL_CompanyCode(aCode:string;var aName:string): string;
var
  stSql : string;
begin
  result := '';
...
function TdmKTAMSDataBase.InsertIntoTB_CONFIG_All(aCONFIGGROUP, aCONFIGCODE,
...
function TdmKTAMSDataBase.ProcessExecSQL(aSql: String;
...
procedure TdmKTAMSDataBase.SetCancel(const Value: Boolean);
begin
  FCancel := Value;
end;

procedure TdmKTAMSDataBase.SetDBConnected(const Value: Boolean);
begin
  FDBConnected := Value;
end;

function TdmKTAMSDataBase.TableVersionCheck: Boolean;
var
...
function TdmKTAMSDataBase.Table_0001_VersionMake: Boolean;
begin
  AlterTB_SLOCAL_RelayCode_Add;
  InsertIntoTB_CONFIG_All('COMMON','TABLEVER','1','');
end;

function TdmKTAMSDataBase.Table_0002_VersionMake: Boolean;
begin
...
function TdmKTAMSDataBase.UpdateTB_CONFIG_Value(aCONFIGGROUP, aCONFIGCODE,
...
function TdmKTAMSDataBase.UpdateTB_SLOCAL_BUILDINGCode(aSLocalCode,
...
function TdmKTAMSDataBase.UpdateTB_SLOCAL_CompanyCode(aSLocalCode,
