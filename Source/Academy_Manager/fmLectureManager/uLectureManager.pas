...
begin
  ...
  GridInit(sg_LectureEmployeeList,4,2,True);
  ...
  stSql := stSql + ' Where a.GROUP_CODE = ''' + G_stGroupCode + ''' ';
  stSql := stSql + ' AND NOT EXISTS ( select CC_CODE From TB_EMPLOYEELecture c where a.EM_SEQ = c.EM_SEQ and c.CC_CODE = ' + stLectureCode + ' and c.EL_STATE = 1 )';
