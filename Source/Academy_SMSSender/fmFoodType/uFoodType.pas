...
begin
  ...
  begin
    ...
    dmDBInsert.InsertIntoTB_FOODCODE_Value(stFoodType,'1','조식','0600','0959','0','0959');
    dmDBInsert.InsertIntoTB_FOODCODE_Value(stFoodType,'2','중식','1000','1559','0','1559');
    dmDBInsert.InsertIntoTB_FOODCODE_Value(stFoodType,'3','석식','6600','1959','0','1959');
    dmDBInsert.InsertIntoTB_FOODCODE_Value(stFoodType,'4','야식','2000','2359','0','2359');
  end else
  begin
