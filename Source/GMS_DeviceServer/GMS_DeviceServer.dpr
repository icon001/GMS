...
uses
  ...
  uDirectServer in '..\..\Lib\MIAMSServer\uDirectServer.pas' {dmDirectServer: TDataModule},
  ...
  uAntiPassLib in '..\..\Lib\AntiPassGroup\uAntiPassLib.pas' {dmAntiPassGroup: TDataModule},
...
//      TObject(ProcessList.Objects[i]).Free;
  ...
  Application.CreateForm(TdmDirectServer, dmDirectServer);
