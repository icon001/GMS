...
begin
  ...
  G_stCardDeleteStopType := inttostr(cmb_StopType.ItemIndex);
  ...
  dmDBUpdate.UpdateTB_CONFIG_Field_StringValue('CARDDELETE','CARDSTOP','CO_CONFIGVALUE',G_stCardDeleteStopType);
...
begin
  ...
  cmb_CardDeleteUse.ItemIndex := strtoint(G_stCardDeleteUse );
  cmb_StopType.ItemIndex := strtoint(G_stCardDeleteStopType );
