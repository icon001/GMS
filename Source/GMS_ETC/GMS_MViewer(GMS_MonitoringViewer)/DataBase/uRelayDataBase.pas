...
type
  TdmRelayDataBase = class(TDataModule)
...
var
  dmRelayDataBase: TdmRelayDataBase;
...
function TdmRelayDataBase.ProcessEventExecSQL(aSql: String): Boolean;
var
  ExecQuery :TADOQuery;
begin
  Result:= False;
...
function TdmRelayDataBase.ProcessExecSQL(aSql: String;
