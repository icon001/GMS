...
uses
  ...
  AdvOfficePagerStylers, ToolPanels, AdvSplitter, AdvDateTimePicker,
...
type
  TfmAccessReport = class(TfmASubForm)
    ...
    AdvOfficePager1_bak: TAdvOfficePager;
    ...
    dt_StartDate: TAdvSmoothDatePicker;
    dt_EndDate: TAdvSmoothDatePicker;
    LoadTimer: TTimer;
  ...
  private
    ...
    L_arrAccessReportSizeTable : Array of integer;
    FEcuID: string;
    FNodeNo: integer;
    FDoorNo: string;
    FDoorName: string;  //출입이벤트 Cell Size
...
procedure TfmAccessReport.Button1Click(Sender: TObject);
begin
  inherited;
  dt_StartDate.Color := clwhite;
  dt_endDate.Refresh;
...
begin
  ...
  cmb_Door.Text := DoorName;
//  SearchReport;
end;


procedure TfmAccessReport.LoadTimerTimer(Sender: TObject);
begin
  inherited;
...
begin
  ...
  ReportHeaderNameList.Add(dmFormFunction.GetFormName('0','2','COMMONCOMPANYNAME') + '1');
  ReportHeaderNameList.Add(dmFormFunction.GetFormName('0','2','COMMONCOMPANYNAME') + '2');
  ReportHeaderNameList.Add(dmFormFunction.GetFormName('0','2','COMMONCOMPANYNAME') + '3');
