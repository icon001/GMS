...
procedure LoadCompanyTreeView(aCode: string;aListView,aCodeView:TTreeview;aImageIndex:integer;aStopCardImageIndex:integer= -1);
...
procedure LoadEmployeeGroupTreeView(aCode: string;aListView,aCodeView:TTreeview;aImageIndex:integer;aStopCardImageIndex:integer= -1);
...
var
  ...
  bFirst : Boolean;
begin
  if aStopCardImageIndex < 0 then aStopCardImageIndex := aImageIndex;
          ...
          begin
            ...
            begin
              ...
              begin
                ...
                if FindField('CO_AUTOPERMITDELETE').AsInteger = 1 then
                begin
                  cNode1.ImageIndex := aStopCardImageIndex;
                  cNode1.SelectedIndex := aStopCardImageIndex;
                end else
                begin
    ...
    begin
      ...
      begin
        Try
          ...
          begin
            bFirst := False;
            aNode1 := aTreeView1.Items.Add(nil,FindField('EM_GROUPCODENAME').AsString);
            vTreeView1.Items.AddChild(nil,FindField('EM_GROUPCODE').AsString);
            aNode1.Expanded := True;
          end else
          begin
            ...
            begin
              ...
              begin
                bNode1.Expanded := True;
                cNode1:= aTreeView1.Items.AddChild(bNode1,FindField('EM_GROUPCODENAME').AsString);
                if FindField('EM_AUTOPERMITDELETE').AsInteger = 1 then
                begin
                  cNode1.ImageIndex := aStopCardImageIndex;
                  cNode1.SelectedIndex := aStopCardImageIndex;
                end else
              ...
              if vNode2 <> nil then
              begin
                vNode3:= vTreeView1.Items.AddChild(vNode2,FindField('EM_GROUPCODE').AsString);
              end;
              vNode1.Expanded := True;
            end;
          end;
