...
type
  ...
  public
    ...
    Function InsertIntoTB_ARMAREA_DeviceARMAREAInit(aNodeNo,aEcuID,aArmAreaNo,aArmAreaName:string;aArmAreaUse:string='0';aArmAreaView:string='0' ):Boolean;
    ...
    Function InsertIntoTB_DECODER_ALL(aDecoderNo,aDecoderSockType,aDecoderName,aDecoderIP,aDevicePort,aControlPort,aFTPPort:string ):Boolean;
    ...
    Function InsertIntoTB_FINGERDEVICE_Value(aFnSeq,aDeviceIP,aDeviceName,aPort,aDeviceType,aCPType,aNodeNo,aEcuID,aExtendID,aDoorNo:string):Boolean;
    ...
    Function InsertIntoTB_READER_ReaderInit(aNodeNo,aEcuID,aReaderNo:string ):Boolean;
    ...
    Function InsertIntoTB_ZONE_ZoneInit(aNodeNo,aEcuID,aExtNo,aZoneNo,aZoneName:string):Boolean;
...
function TdmDBInsert.InsertIntoTB_ARMAREA_DeviceARMAREAInit(aNodeNo, aEcuID,
  aArmAreaNo, aArmAreaName: string;aArmAreaUse:string='0';aArmAreaView:string='0'): Boolean;
var
  stSql : string;
begin
...
function TdmDBInsert.InsertIntoTB_DECODER_ALL(aDecoderNo, aDecoderSockType,
  aDecoderName, aDecoderIP, aDevicePort, aControlPort,aFTPPort: string): Boolean;
var
  stSql : string;
begin
...
function TdmDBInsert.InsertIntoTB_READER_ReaderInit(aNodeNo, aEcuID, aReaderNo: string): Boolean;
var
  stSql : string;
begin
...
function TdmDBInsert.InsertIntoTB_ZONE_ZoneInit(aNodeNo, aEcuID, aExtNo,
  aZoneNo, aZoneName: string): Boolean;
var
  stSql : string;
begin
