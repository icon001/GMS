...
type
  ...
  private
    ...
    FOnDeviceStateRefresh: TMonitorAlarmEventListClear;
  ...
  public
    property OnDeviceStateRefresh : TMonitorAlarmEventListClear read FOnDeviceStateRefresh write FOnDeviceStateRefresh;
...
begin
  ...
  Try
    ...
    begin
      ...
      if Assigned(FOnDeviceStateRefresh) then
      begin
        OnDeviceStateRefresh(Self);   //기기 상태를 다시 확인 하자 통신에러에 의한
      end;
