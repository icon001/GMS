...
type
  ...
  TBuildingAlarmEventStateChange = procedure(Sender:TObject;aBuildingCode:string;aAlaramState:TAlarmEventState) of object;
  ...
  TDeviceAlarmEventStateChange = procedure(Sender:TObject;NodeNo:integer;aECUID,aAlarmArea,aBuildingCode,aFloorCode,aAreaCode:string;aAlaramState:TAlarmEventState) of object;
  ...
  TMonitorAlarmEventListClear = procedure(Sender:TObject) of object;
  TNodeConnectedStateEvent = procedure (Sender:TObject;aNodeNo:integer;aConnectedState:TNodeConnectedState) of object;
