...
begin
  stFormStyle := UpperCase(aFormStyle);
  if stFormStyle = UpperCase('bsCustom') then oControl.Style := TToolBarStyle(bsCustom)
  else if stFormStyle = UpperCase('bsOffice2003Blue') then oControl.Style := TToolBarStyle(bsOffice2003Blue)
  else if stFormStyle = UpperCase('bsOffice2003Classic') then oControl.Style := TToolBarStyle(bsOffice2003Classic)
  else if stFormStyle = UpperCase('bsOffice2003Olive') then oControl.Style := TToolBarStyle(bsOffice2003Olive)
  else if stFormStyle = UpperCase('bsOffice2003Silver') then oControl.Style := TToolBarStyle(bsOffice2003Silver)
  else if stFormStyle = UpperCase('bsOffice2007Luna') then oControl.Style := TToolBarStyle(bsOffice2007Luna)
  else if stFormStyle = UpperCase('bsOffice2007Obsidian') then oControl.Style := TToolBarStyle(bsOffice2007Obsidian)
  else if stFormStyle = UpperCase('bsOffice2007Silver') then oControl.Style := TToolBarStyle(bsOffice2007Silver)
  else if stFormStyle = UpperCase('bsOffice2010Black') then oControl.Style := TToolBarStyle(bsOffice2010Black)
  else if stFormStyle = UpperCase('bsOffice2010Blue') then oControl.Style := TToolBarStyle(bsOffice2010Blue)
  else if stFormStyle = UpperCase('bsOffice2010Silver') then oControl.Style := TToolBarStyle(bsOffice2010Silver)
  else if stFormStyle = UpperCase('bsOfficeXP') then oControl.Style := TToolBarStyle(bsOfficeXP)
  else if stFormStyle = UpperCase('bsTerminal') then oControl.Style := TToolBarStyle(bsTerminal)
  else if stFormStyle = UpperCase('bsWhidbeyStyle') then oControl.Style := TToolBarStyle(bsWhidbeyStyle)
  else if stFormStyle = UpperCase('bsWindows7') then oControl.Style := TToolBarStyle(bsWindows7)
  else if stFormStyle = UpperCase('bsWindowsVista') then oControl.Style := TToolBarStyle(bsWindowsVista)
  else if stFormStyle = UpperCase('bsWindowsXP') then oControl.Style := TToolBarStyle(bsWindowsXP)
  ;
end;
