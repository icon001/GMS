...
uses
  ...
  AdvOfficeTabSetStylers, CommandArray, AdvPageControl;
...
type
  TfmDeviceState = class(TfmASubForm)
    ...
    tv_DeviceCode: TTreeView;    procedure FormDockOver(Sender: TObject; Source: TDragDockObject; X, Y: Integer; State: TDragState; var Accept: Boolean);
