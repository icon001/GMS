...
type
  ...
  public
    ...
    Function SelectTB_ACCESSEVENT_AccessReport(aStartDate,aStartTime,aEndDate,aEndTime,aBuildingCode,aNodeNo,aEcuID,aDoorNo,aCompanyCode,aPosiCode,aCardState,aEmGubun,aEtcType,aEtcName:string;aTimeType:integer=0):string;
    ...
    Function SelectTB_ARMAREA_AdminArmArea(aUserID:string):string;
    Function SelectTB_ARMAREA_AdminBuilding(aUserID:string):string;
    Function SelectTB_ARMAREA_BuildingCode(aBuildingCode:string):string;
    ...
    Function SelectTB_ARMAREA_MasterAll:string;
    ...
    function SelectTB_CARDPERMITEMPLOYEECODE_GradeReport(aBuildingCode,aNodeNo,aEcuID,aDoorNo,aCompanyCode,aPosiCode,aCardState,aEmGubun,aEtcType,aEtcName:string;aTimeType:integer=0):string;
    ...
    Function SelectTB_DEVICE_DeviceVersion(aNodeNo,aEcuID:string):string;
    Function SelectTB_DEVICE_List(aNodeNo,aEcuID:string):string;
    Function SelectTB_DOOR_AdminBuilding(aUserID:string):string;
    Function SelectTB_DOOR_AdminDoor(aUserID:string):string;
    Function SelectTB_DOOR_AntiPass:string;
    Function SelectTB_DOOR_BuildingCode(aBuildingCode:string;aLike:Boolean = False):string;
    ...
    Function SelectTB_DOOR_MasterAll:string;
    ...
    Function SelectTB_EMPLOYE_Value(aCompanyCode,aPosiCode,aEmSeq,aEmCode,aEmName,aEmGubun,aEmHandPhone,aEmCompanyPhone,aEtcInfo,aInDate,aOutDate,aACType,aATType,aFDTyep:string;aCardInclude:Boolean=False;aNotCardReg:string='';aNotFpReg:string='';aCardNo:string=''):string;
    ...
    Function SelectTB_NODE_Name(aBuildingCode,aName:string):string;
...
begin
  ...
  stSql := stSql + ' b.DO_DOORNAME,f.CO_COMPANYNAME as COMPANYNAME1,g.CO_COMPANYNAME as COMPANYNAME2,h.CO_COMPANYNAME as COMPANYNAME3, ';
...
begin
  stSql := ' Select a.AE_DATE,a.AE_TIME,c.BC_BUILDINGNAME as BUILDINGNAME1,d.BC_BUILDINGNAME as BUILDINGNAME2,e.BC_BUILDINGNAME as BUILDINGNAME3, ';
  stSql := stSql + ' b.DO_DOORNAME,h.CO_COMPANYNAME as COMPANYNAME1,i.CO_COMPANYNAME as COMPANYNAME2,j.CO_COMPANYNAME as COMPANYNAME3, ';
...
begin
  stSql := ' Select a.AE_DATE,a.AE_TIME,c.BC_BUILDINGNAME as BUILDINGNAME1,d.BC_BUILDINGNAME as BUILDINGNAME2,e.BC_BUILDINGNAME as BUILDINGNAME3, ';
  stSql := stSql + ' b.AR_ARMAREANAME,h.CO_COMPANYNAME as COMPANYNAME1,i.CO_COMPANYNAME as COMPANYNAME2,j.CO_COMPANYNAME as COMPANYNAME3, ';
...
function TdmDBSelect.SelectTB_ARMAREA_AdminArmArea(aUserID: string): string;
var
  stSql : string;
begin
  ...
  stSql := stSql + ' Order by a.AR_VIEWSEQ,a.ND_NODENO,a.DE_ECUID,a.AR_ARMAREANO ';
  result := stSql;
end;

function TdmDBSelect.SelectTB_ARMAREA_AdminBuilding(aUserID: string): string;
var
  stSql : string;
begin
  if G_nDBType = MDB then
...
function TdmDBSelect.SelectTB_ARMAREA_MasterAll: string;
var
  stSql : string;
begin
  if G_nDBType = MDB then
...
var
  stSql : string;
begin
  stSql := ' Select a.AT_DATE,c.CO_COMPANYNAME as COMPANYNAME1,d.CO_COMPANYNAME as COMPANYNAME2,e.CO_COMPANYNAME as COMPANYNAME3, ';
...
begin
  ...
  if G_nDBType = MSSQL then stSql := stSql + ' AND len(BC_BUILDINGCODE) = ' + inttostr(1 + G_nBuildingCodeLength * (G_nBuildingStep + 1)) + ' '
  else if G_nDBType = MDB then stSql := stSql + ' AND len(BC_BUILDINGCODE) = ' + inttostr(1 + G_nBuildingCodeLength * (G_nBuildingStep + 1)) + ' '
  else if G_nDBType = PostGresql then stSql := stSql + ' AND length(BC_BUILDINGCODE) = ' + inttostr(1 + G_nBuildingCodeLength * (G_nBuildingStep + 1)) + ' '
  else stSql := stSql + ' AND length(BC_BUILDINGCODE) = ' + inttostr(1 + G_nBuildingCodeLength * (G_nBuildingStep + 1)) + ' ';
  stSql := stSql + ' Order by BC_VIEWSEQ,BC_BUILDINGCODE ';
...
function TdmDBSelect.SelectTB_CARDPERMITEMPLOYEECODE_GradeReport(aBuildingCode,
  ...
  aEtcType, aEtcName: string; aTimeType: integer): string;
var
  stSql : string;
begin
  stSql := ' select a.EM_SEQ,g.EM_CODE,g.EM_NAME,f.CA_CARDNO,o.CA_CARDGUBUNNAME,b.DO_DOORNAME,a.CP_PERMIT,a.CP_APPLY,a.CP_FINGERAPPLY,i.CP_RCVACK ';
...
var
  stSql : string;
begin
  stSql := 'select b.ND_NODENAME,a.ND_NODENO,a.DE_ECUID,a.DE_DEVICENAME,a.DE_DEVICEVER from TB_DEVICE a ';
  stSql := stSql + ' Inner Join TB_NODE b ';
  stSql := stSql + ' ON (a.GROUP_CODE = b.GROUP_CODE ';
  stSql := stSql + ' AND a.ND_NODENO = b.ND_NODENO) ';
  stSql := stSql + ' Where a.GROUP_CODE = ''' + G_stGroupCode + ''' ';
...
begin
  ...
  stSql := stSql + ' b.DO_DOORNAME,a.DE_TELNUMBER,a.DE_PASSWORD,a.DE_ACCESSNAME,a.DE_ACCESSCOMPANY,a.DE_ACCESSTEL,a.DE_ACCESSMEMO ';
...
function TdmDBSelect.SelectTB_DOOR_AdminBuilding(aUserID: string): string;
var
  stSql : string;
begin
  if G_nDBType = MDB then
  ...
  stSql := stSql + ' Order by a.DO_VIEWSEQ,a.BC_BUILDINGCODE,a.ND_NODENO,a.DE_ECUID,a.DO_DOORNO ';
  result := stSql;
end;

function TdmDBSelect.SelectTB_DOOR_AdminDoor(aUserID: string): string;
var
  stSql : string;
begin
  if G_nDBType = MDB then
...
function TdmDBSelect.SelectTB_DOOR_BuildingCode(aBuildingCode: string;aLike:Boolean = False): string;
var
  stSql : string;
begin
  if G_nDBType = MDB then
...
begin
  ...
  stSql := stSql + 'a.DO_DOORNO,a.DO_DOORNAME,g.ND_NODEIP,g.ND_LASTNETSTATE,g.ND_LASTNETSTATE,b.EM_SEQ,f.EM_CODE,f.EM_NAME,f.EM_HANDPHONE ';
  stSql := stSql + ' From TB_DOOR a ';
...
function TdmDBSelect.SelectTB_DOOR_MasterAll: string;
var
  stSql : string;
begin
  if G_nDBType = MDB then
...
function TdmDBSelect.SelectTB_EMPLOYE_Value(aCompanyCode, aPosiCode,aEmSeq, aEmCode,
  ...
  aACType, aATType, aFDTyep: string;aCardInclude:Boolean=False;aNotCardReg:string='';aNotFpReg:string='';aCardNo:string=''): string;
var
  stSql : string;
begin
  if G_nDBType = MDB then
  begin
    ...
    stSql := stSql + ' ON ( a.GROUP_CODE = e.GROUP_CODE ) ';
    stSql := stSql + ' AND ( a.EM_GROUPCODE = e.EM_GROUPCODE ) ';
    if aCardInclude or (aCardNo <> '') then
    begin
      stSql := stSql + ' ) ';
      if aCardNo <> '' then
      begin
        stSql := stSql + ' Inner Join (select * from TB_CARD where CA_CARDNO = ''' + aCardNo + ''' )f ';
      end else
      begin
        if G_nCardFPType <>  2 then stSql := stSql + ' Left Join (select * from TB_CARD where CA_STATECODE = ''1''  AND CA_CARDGUBUN <> 0 )f '
        else stSql := stSql + ' Left Join (select * from TB_CARD where CA_STATECODE = ''1''  AND CA_CARDGUBUN = 0 )f ';
      end;
...
var
  stSql : string;
begin
  stSql := ' Select a.FE_DATE,a.FE_TIME,c.CO_COMPANYNAME as COMPANYNAME1,d.CO_COMPANYNAME as COMPANYNAME2,e.CO_COMPANYNAME as COMPANYNAME3, ';
...
begin
  ...
  stSql := ' Select c.CO_COMPANYNAME as COMPANYNAME1,d.CO_COMPANYNAME as COMPANYNAME2,e.CO_COMPANYNAME as COMPANYNAME3, ';
...
function TdmDBSelect.SelectTB_NODE_Name(aBuildingCode,aName: string): string;
var
  stSql : string;
begin
