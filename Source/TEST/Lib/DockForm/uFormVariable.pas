...
const
  ...
  con_FormBMOSARMAREAACCESSREPORT = 21;
  con_FormBMOSARMAREACODE = 22;
  con_FormBMOSArmAreaMangementREPORT = 23;
  con_FormBMOSARMAREAMAP = 24;
  con_FormBMOSATREPORT = 25;
  con_FormBMOSBUILDINGCODE = 30;
  con_FormBMOSBUILDINGMAP = 31;
  con_FormBMOSBUTTONEVENTREPORT = 32;
  con_FormBMOSCARDREGESTFORM = 33;
  con_FormBMOSCOMPANYCODE = 34;
  con_FormBMOSCOMPANYGRADE = 35;
  ...
  con_FormBMOSEMPLOYEEGRADESEARCH = 53;
  con_FormBMOSEMPLOYEEGUBUN = 54;
  con_FormBMOSFPCARDEMPLOYEE = 55;
  con_FormBMOSFOODDEPARTSTATEREPORT = 56;
  con_FormBMOSFOODEVENTREPORT = 57;
  con_FormBMOSFOODMONITOR = 58;
  con_FormBMOSFOODSTATEREPORT = 59;
  con_FormBMOSHOLIDAYADMIN = 60;
