...
//    showmessage(inttostr(ImageEnVect1.Height) + '/' + inttostr(ImageEnVect1.Width));
  ...
  self.FindSubForm('Main').FindCommand('ALARMCONFIRM').Execute;
end;
...
begin
  Try
    ...
    self.FindSubForm('Main').FindCommand('REPORT').Params.Values['ID'] := L_stSelectCode;
