...
begin
  ...
  begin
    onCurrentDoorState(Self,ClientSocket(Device.DeviceNode).NO,TDevice(Device).EcuID,'0',inttostr(DoorNo),CardMode,DoorMode,DoorCurrentDSState,DoorCurrentLSState,DoorCurrentFireEvent);
  end;
end;
...
begin
  Try
    ...
    SendPacket('c',ClientSocket(Device.DeviceNode).GetSendMsgNo,ClientSocket(Device.DeviceNode).GetDeviceVer, stData,0);
    if aDelay then
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        begin
          OnDoorHolidaySend(Self,con_DoorCmdHOLIDAY,ClientSocket(Device.DeviceNode).NO,TDevice(Device).EcuID,'0',inttostr(DoorNo),HolidayDelList.Strings[i] + '0');
        end;
  ...
  begin
    ...
    begin
      ...
      begin
        if Assigned(FOnDoorHolidaySend) then
        begin
          OnDoorHolidaySend(Self,con_DoorCmdHOLIDAY,ClientSocket(Device.DeviceNode).NO,TDevice(Device).EcuID,'0',inttostr(DoorNo),HolidayRegList.Strings[i] + '1');
        end;
...
begin
  ...
  begin
    OnDoorPacketChange(Self,con_DoorCmdAntiNo,ClientSocket(Device.DeviceNode).NO,TDevice(Device).EcuID,'0',inttostr(DoorNo),inttostr(Value));
  end;
end;
...
begin
  ...
  if Assigned(FOnDoorPacketChange) then
  begin
    OnDoorPacketChange(Self,con_DoorCmdArmArea,ClientSocket(Device.DeviceNode).NO,TDevice(Device).EcuID,'0',inttostr(DoorNo),inttostr(Value));
  end;
end;
...
begin
  ...
  if Assigned(FOnDoorPacketChange) then
  begin
    OnDoorPacketChange(Self,con_DoorCmdARMDSCHECK,ClientSocket(Device.DeviceNode).NO,TDevice(Device).EcuID,'0',inttostr(DoorNo),Value);
  end;
end;
...
begin
  ...
  begin
    OnReceiveTypeChage(Self,ClientSocket(Device.DeviceNode).NO,'DOOR',TDevice(Device).EcuID,'0',inttostr(DoorNo),con_DoorCmdARMDSCHECK,Value);
  end;
end;
...
begin
  ...
  if Assigned(FOnReceiveTypeChage) then
  begin
    OnReceiveTypeChage(Self,ClientSocket(Device.DeviceNode).NO,'DOOR',TDevice(Device).EcuID,'0',inttostr(DoorNo),con_DoorCmdSCHEDULEDATA,Value);
  end;
end;
...
begin
  ...
  if Assigned(FOnReceiveTypeChage) then
  begin
    OnReceiveTypeChage(Self,ClientSocket(Device.DeviceNode).NO,'DOOR',TDevice(Device).EcuID,'0',inttostr(DoorNo),con_DoorCmdSettingInfo,Value);
  end;
end;
...
begin
  ...
  if Assigned(FOnDoorPacketChange) then
  begin
    OnDoorPacketChange(Self,con_DoorCmdCONTROLTIME,ClientSocket(Device.DeviceNode).NO,TDevice(Device).EcuID,'0',inttostr(DoorNo),Value);
  end;
end;
...
begin
  ...
  if Assigned(FOnDoorPacketChange) then
  begin
    OnDoorPacketChange(Self,con_DoorCmdName,ClientSocket(Device.DeviceNode).NO,TDevice(Device).EcuID,'0',inttostr(DoorNo),Value);
  end;
end;
...
begin
  ...
  if Assigned(FOnDOORPacketChange) then
  begin
    OnDOORPacketChange(Self,con_DOORCmdSTATE,ClientSocket(Device.DeviceNode).NO,TDevice(Device).EcuID,'0',inttostr(DoorNo),Value);
  end;
end;
...
begin
  ...
  if Assigned(FOnDoorPacketChange) then
  begin
    OnDoorPacketChange(Self,con_DoorCmdType,ClientSocket(Device.DeviceNode).NO,TDevice(Device).EcuID,'0',inttostr(DoorNo),Value);
  end;
end;
...
begin
  ...
  if Assigned(FOnDoorPacketChange) then
  begin
    OnDoorPacketChange(Self,con_DoorCmdUse,ClientSocket(Device.DeviceNode).NO,TDevice(Device).EcuID,'0',inttostr(DoorNo),stDoorUse);
  end;
...
begin
  ...
  if Assigned(FOnDoorPacketChange) then
  begin
    OnDoorPacketChange(Self,con_DoorCmdView,ClientSocket(Device.DeviceNode).NO,TDevice(Device).EcuID,'0',inttostr(DoorNo),Value);
  end;
end;
...
begin
  ...
  if Assigned(FOnDoorPacketChange) then
  begin
    OnDoorPacketChange(Self,con_DoorCmdDeadBoltDSCHECKTIME,ClientSocket(Device.DeviceNode).NO,TDevice(Device).EcuID,'0',inttostr(DoorNo),Value);
  end;
end;
...
begin
  ...
  if Assigned(FOnReceiveTypeChage) then
  begin
    OnReceiveTypeChage(Self,ClientSocket(Device.DeviceNode).NO,'DOOR',TDevice(Device).EcuID,'0',inttostr(DoorNo),con_DoorCmdDeadBoltDSCHECKTIME,Value);
  end;
end;
...
begin
  ...
  if Assigned(FOnDoorPacketChange) then
  begin
    OnDoorPacketChange(Self,con_DoorCmdDeadBoltDSCHECKUSE,ClientSocket(Device.DeviceNode).NO,TDevice(Device).EcuID,'0',inttostr(DoorNo),Value);
  end;
end;
...
begin
  ...
  if Assigned(FOnReceiveTypeChage) then
  begin
    OnReceiveTypeChage(Self,ClientSocket(Device.DeviceNode).NO,'DOOR',TDevice(Device).EcuID,'0',inttostr(DoorNo),con_DoorCmdDeadBoltDSCHECKUSE,Value);
  end;
end;
...
begin
  ...
  begin
    OnDoorLongTimeOpenEvent(Self,con_DoorCmdDSOPENSTATE,ClientSocket(Device.DeviceNode).NO,TDevice(Device).EcuID,'0',inttostr(DoorNo),Value);
  end;
...
//  if (FDoorCurrentDSState <> '') and (Value <> '') then   //처음 기동하여 상태 확인시에는 로그 남기지 말자.
  ...
  begin
    if Assigned(FOnDoorPacketChange) then
    begin
      OnDoorPacketChange(Self,con_DoorCurrentDSState,ClientSocket(Device.DeviceNode).NO,TDevice(Device).EcuID,'0',inttostr(DoorNo),Value);
    end;
  end;
...
begin
  ...
  if Assigned(FOnDoorPacketChange) then
  begin
    OnDoorPacketChange(Self,con_DoorCmdDSOPENSTATE,ClientSocket(Device.DeviceNode).NO,TDevice(Device).EcuID,'0',inttostr(DoorNo),Value);
  end;
end;
...
begin
  ...
  if Assigned(FOnDoorPacketChange) then
  begin
    OnDoorPacketChange(Self,con_DoorCmdFIREDOOROPEN,ClientSocket(Device.DeviceNode).NO,TDevice(Device).EcuID,'0',inttostr(DoorNo),Value);
  end;
end;
...
begin
  ...
  if Assigned(FOnDoorPacketChange) then
  begin
    OnDoorPacketChange(Self,con_DoorCmdHOLIDAY,ClientSocket(Device.DeviceNode).NO,TDevice(Device).EcuID,'0',inttostr(DoorNo),Value);
  end;
end;
...
begin
  ...
  if Assigned(FOnDoorPacketChange) then
  begin
    OnDoorPacketChange(Self,con_DoorCmdLOCKSTATE,ClientSocket(Device.DeviceNode).NO,TDevice(Device).EcuID,'0',inttostr(DoorNo),Value);
  end;
...
begin
  ...
  if Assigned(FOnDoorPacketChange) then
  begin
    OnDoorPacketChange(Self,con_DoorCmdLOCKTYPE,ClientSocket(Device.DeviceNode).NO,TDevice(Device).EcuID,'0',inttostr(DoorNo),inttostr(Value));
  end;
end;
...
begin
  ...
  if Assigned(FOnDoorPacketChange) then
  begin
    OnDoorPacketChange(Self,con_DoorCmdLONGOPENALARM,ClientSocket(Device.DeviceNode).NO,TDevice(Device).EcuID,'0',inttostr(DoorNo),Value);
  end;
end;
...
begin
  ...
  if Assigned(FOnDoorPacketChange) then
  begin
    OnDoorPacketChange(Self,con_DoorCmdLONGOPENTIME,ClientSocket(Device.DeviceNode).NO,TDevice(Device).EcuID,'0',inttostr(DoorNo),Value);
  end;
end;
...
begin
  ...
  if Assigned(FOnDoorPacketChange) then
  begin
    OnDoorPacketChange(Self,con_DoorCmdREMOTEDISARMDOOROPEN,ClientSocket(Device.DeviceNode).NO,TDevice(Device).EcuID,'0',inttostr(DoorNo),Value);
  end;
end;
...
begin
  ...
  if Assigned(FOnDoorPacketChange) then
  begin
    OnDoorPacketChange(Self,con_DoorCmdSCHEDULEUSE,ClientSocket(Device.DeviceNode).NO,TDevice(Device).EcuID,'0',inttostr(DoorNo),Value);
  end;
end;
...
begin
  ...
  if Assigned(FOnDoorPacketChange) then
  begin
    OnDoorPacketChange(Self,con_DoorCmdTimeCodeUse,ClientSocket(Device.DeviceNode).NO,TDevice(Device).EcuID,'0',inttostr(DoorNo),Value);
  end;
end;
