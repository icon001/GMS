...
begin
  ...
  begin
    OnZonePacketChange(Self,con_ZoneCmdAlarmEventType,ClientSocket(Device.DeviceNode).NO,TDevice(Device).EcuID,inttostr(EXTENDID),inttostr(ZoneNo),Value);
  end;
end;
...
begin
  ...
  if Assigned(FOnZonePacketChange) then
  begin
    OnZonePacketChange(Self,con_ZoneCmdArmArea,ClientSocket(Device.DeviceNode).NO,TDevice(Device).EcuID,inttostr(EXTENDID),inttostr(ZoneNo),Value);
  end;
end;
...
begin
  ...
  if Assigned(FOnZonePacketChange) then
  begin
    OnZonePacketChange(Self,con_ZoneCmdEventStateCode,ClientSocket(Device.DeviceNode).NO,TDevice(Device).EcuID,inttostr(EXTENDID),inttostr(ZoneNo),Value);
  end;
end;
...
begin
  ...
  if Assigned(FOnZonePacketChange) then
  begin
    OnZonePacketChange(Self,con_ZoneCmdDelayUse,ClientSocket(Device.DeviceNode).NO,TDevice(Device).EcuID,inttostr(EXTENDID),inttostr(ZoneNo),Value);
  end;
end;
...
begin
  ...
  if Assigned(FOnZonePacketChange) then
  begin
    OnZonePacketChange(Self,con_ZoneCmdRecovery,ClientSocket(Device.DeviceNode).NO,TDevice(Device).EcuID,inttostr(EXTENDID),inttostr(ZoneNo),Value);
  end;
end;
...
begin
  ...
  if Assigned(FOnZonePacketChange) then
  begin
    OnZonePacketChange(Self,con_ZoneCmdSenseTime,ClientSocket(Device.DeviceNode).NO,TDevice(Device).EcuID,inttostr(EXTENDID),inttostr(ZoneNo),Value);
  end;
end;
...
begin
  ...
  begin
    OnReceiveTypeChage(Self,ClientSocket(Device.DeviceNode).NO,'ZONE',TDevice(Device).EcuID,'0',inttostr(ZoneNo),con_ZoneCmdSetting,Value);
  end;
end;
...
begin
  ...
  if Assigned(FOnZonePacketChange) then
  begin
    OnZonePacketChange(Self,con_ZoneCmdType,ClientSocket(Device.DeviceNode).NO,TDevice(Device).EcuID,inttostr(EXTENDID),inttostr(ZoneNo),Value);
  end;
end;
...
begin
  ...
  Try
    for i := 0 to HIGH(L_cZoneRCVSTATE) do
    begin
      if (L_cZoneRCVSTATE[i] = 'U') or (L_cZoneRCVSTATE[i] = 'S') then  //변경된 건이 있으면 송신 하자....
      begin
