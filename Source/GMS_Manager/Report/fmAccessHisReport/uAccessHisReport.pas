...
type
  TfmAccessHisReport = class(TfmASubForm)
    Image1: TImage;
...
var
  fmAccessHisReport: TfmAccessHisReport;
...
function TfmAccessHisReport.AccessReportFieldNameSetting: Boolean;
begin
...
function TfmAccessHisReport.AccessReportHeaderNameSetting(aList: TAdvStringGrid): Boolean;
var
  i : integer;
begin
...
procedure TfmAccessHisReport.btn_CloseClick(Sender: TObject);
begin
  inherited;
  Close;
end;

procedure TfmAccessHisReport.btn_ExcelClick(Sender: TObject);
var
...
procedure TfmAccessHisReport.btn_minimizeClick(Sender: TObject);
begin
  inherited;
  windowState := wsNormal;
end;

procedure TfmAccessHisReport.btn_OptionCancelClick(Sender: TObject);
begin
  inherited;
  Pan_Option.Visible := False;
end;

procedure TfmAccessHisReport.btn_OptionClick(Sender: TObject);
var
  i : integer;
begin
  inherited;
...
procedure TfmAccessHisReport.btn_OptionSaveClick(Sender: TObject);
var
  ini_fun : TiniFile;
  i : integer;
begin
  Try
    ini_fun := TiniFile.Create(G_stExeFolder + '\AccessHisReport.INI');
    with ini_fun do
    begin
...
procedure TfmAccessHisReport.btn_PrintClick(Sender: TObject);
begin
  sg_Report.Print;
end;

procedure TfmAccessHisReport.btn_SearchClick(Sender: TObject);
begin
  inherited;
  SearchReport;
end;

procedure TfmAccessHisReport.ChangeAccessReportIndex(FromIndex, ToIndex: integer);
var
  i : integer;
  nChangData : integer;
begin
...
procedure TfmAccessHisReport.cmb_DoorChange(Sender: TObject);
begin
  inherited;
  if G_nReportSearchType = 1 then  SearchReport;
end;

procedure TfmAccessHisReport.cmb_ETCChange(Sender: TObject);
begin
  inherited;
...
procedure TfmAccessHisReport.CommandArrayCommandsTMENUIDExecute(Command: TCommand;
  Params: TStringList);
begin
  inherited;
...
procedure TfmAccessHisReport.eb_BuildingNameClickBtn(Sender: TObject);
begin
  inherited;
...
procedure TfmAccessHisReport.eb_CompanyNameClickBtn(Sender: TObject);
begin
  inherited;
...
procedure TfmAccessHisReport.ed_AddNameKeyPress(Sender: TObject;
  var Key: Char);
begin
  inherited;
  if Key = #13 then
...
procedure TfmAccessHisReport.ed_nameKeyPress(Sender: TObject; var Key: Char);
begin
  inherited;
  if Key = #13 then
  begin
...
procedure TfmAccessHisReport.ed_nameKeyUp(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  inherited;
  if G_nReportSearchType = 1 then  SearchReport;
...
procedure TfmAccessHisReport.FontSetting;
begin
...
procedure TfmAccessHisReport.FormActivate(Sender: TObject);
begin
  inherited;
  WindowState := wsMaximized;
end;

procedure TfmAccessHisReport.FormChangeEvent(aFormName: integer);
begin
end;

procedure TfmAccessHisReport.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
  WriteIniConfig;

  fmMain.FORMENABLE(con_FormBMOSACCESSHISREPORT,'FALSE');

  MemoryFree;
  Action := caFree;
end;

function TfmAccessHisReport.FormComboBoxInitialize: Boolean;
var
...
procedure TfmAccessHisReport.FormCreate(Sender: TObject);
begin
...
procedure TfmAccessHisReport.FormGradeRefresh;
begin
//    btn_Excel.Enabled := IsUpdateGrade;
//    btn_Print.Enabled := IsInsertGrade;
end;

function TfmAccessHisReport.FormGridInitialize: Boolean;
begin
  GridInitialize(sg_Report);
  ReportCellHide(sg_Report);
end;

procedure TfmAccessHisReport.FormIDSetting(aID: string);
begin
  L_stMenuID := aID;
end;

function TfmAccessHisReport.FormNameSetting: Boolean;
var
  i : integer;
begin
...
procedure TfmAccessHisReport.FormResize(Sender: TObject);
begin
  inherited;
...
procedure TfmAccessHisReport.FormShow(Sender: TObject);
begin
  fmMain.FORMENABLE(con_FormBMOSACCESSHISREPORT,'TRUE');
...
function TfmAccessHisReport.MemoryCreate: Boolean;
begin
...
function TfmAccessHisReport.MemoryFree: Boolean;
begin
...
function TfmAccessHisReport.ReportCellHide(aList: TAdvStringGrid): Boolean;
var
  i : integer;
begin
...
function TfmAccessHisReport.ReportConfigRead: Boolean;
var
  ini_fun : TiniFile;
  nShowCount : integer;
  nSize : integer;
...
function TfmAccessHisReport.ReportHeaderNameSetting: Boolean;
begin
...
function TfmAccessHisReport.SearchReport: Boolean;
var
  stStartDate : string;
  stStartTime : string;
  stEndDate : string;
...
begin
  ...
  stSql :=  dmDBSelect.SelectTB_ACCESSEVENT_AccessHistoryReport(stStartDate, stStartTime,
...
procedure TfmAccessHisReport.sg_reportColumnMoved(Sender: TObject; FromIndex,
  ToIndex: Integer);
begin
  inherited;
...
procedure TfmAccessHisReport.tv_AddCompanyNameDblClick(Sender: TObject);
begin
  inherited;
...
procedure TfmAccessHisReport.tv_buildingNameDblClick(Sender: TObject);
begin
  inherited;
...
function TfmAccessHisReport.WriteIniConfig: Boolean;
var
  ini_fun : TiniFile;
  i : integer;
begin
...
initialization
  RegisterClass(TfmAccessHisReport);
Finalization
  UnRegisterClass(TfmAccessHisReport);
