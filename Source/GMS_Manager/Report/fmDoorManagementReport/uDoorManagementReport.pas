...
type
  TfmDoorManagementReport = class(TfmASubForm)
    Image1: TImage;
...
var
  fmDoorManagementReport: TfmDoorManagementReport;
...
function TfmDoorManagementReport.AccessReportHeaderNameSetting(aList: TAdvStringGrid): Boolean;
var
  i : integer;
begin
...
procedure TfmDoorManagementReport.btn_CloseClick(Sender: TObject);
begin
  inherited;
  Close;
end;

procedure TfmDoorManagementReport.btn_ExcelClick(Sender: TObject);
var
...
procedure TfmDoorManagementReport.btn_minimizeClick(Sender: TObject);
begin
  inherited;
  windowState := wsNormal;
end;

procedure TfmDoorManagementReport.btn_OptionCancelClick(Sender: TObject);
begin
  inherited;
  Pan_Option.Visible := False;
end;

procedure TfmDoorManagementReport.btn_OptionClick(Sender: TObject);
var
  i : integer;
begin
  inherited;
...
procedure TfmDoorManagementReport.btn_OptionSaveClick(Sender: TObject);
var
  ini_fun : TiniFile;
  i : integer;
begin
...
procedure TfmDoorManagementReport.btn_PrintClick(Sender: TObject);
begin
  sg_Report.Print;
end;

procedure TfmDoorManagementReport.btn_SearchClick(Sender: TObject);
begin
  inherited;
  SearchReport;
end;

procedure TfmDoorManagementReport.ChangeAccessReportIndex(FromIndex, ToIndex: integer);
var
  i : integer;
  nChangData : integer;
begin
...
procedure TfmDoorManagementReport.cmb_DoorChange(Sender: TObject);
begin
  inherited;
  if G_nReportSearchType = 1 then  SearchReport;
end;

procedure TfmDoorManagementReport.eb_BuildingNameClickBtn(Sender: TObject);
begin
  inherited;
...
procedure TfmDoorManagementReport.ed_AddNameKeyPress(Sender: TObject;
  var Key: Char);
begin
  inherited;
  if Key = #13 then
...
procedure TfmDoorManagementReport.ed_nameKeyPress(Sender: TObject; var Key: Char);
begin
  inherited;
  if Key = #13 then
  begin
...
procedure TfmDoorManagementReport.FontSetting;
begin
...
procedure TfmDoorManagementReport.FormActivate(Sender: TObject);
begin
  inherited;
  WindowState := wsMaximized;
end;

procedure TfmDoorManagementReport.FormChangeEvent(aFormName: integer);
begin
end;

procedure TfmDoorManagementReport.FormClose(Sender: TObject;
...
function TfmDoorManagementReport.FormComboBoxInitialize: Boolean;
begin
...
procedure TfmDoorManagementReport.FormCreate(Sender: TObject);
begin
...
procedure TfmDoorManagementReport.FormGradeRefresh;
begin
//    btn_Excel.Enabled := IsUpdateGrade;
//    btn_Print.Enabled := IsInsertGrade;
end;

function TfmDoorManagementReport.FormGridInitialize: Boolean;
begin
  GridInitialize(sg_Report);
  ReportCellHide(sg_Report);
end;

procedure TfmDoorManagementReport.FormIDSetting(aID: string);
begin
  L_stMenuID := aID;
end;

function TfmDoorManagementReport.FormNameSetting: Boolean;
var
  i : integer;
begin
...
procedure TfmDoorManagementReport.FormResize(Sender: TObject);
begin
  inherited;
...
procedure TfmDoorManagementReport.FormShow(Sender: TObject);
begin
...
function TfmDoorManagementReport.MemoryCreate: Boolean;
begin
...
function TfmDoorManagementReport.MemoryFree: Boolean;
begin
...
function TfmDoorManagementReport.ReportCellHide(aList: TAdvStringGrid): Boolean;
var
  i : integer;
begin
...
function TfmDoorManagementReport.ReportConfigRead: Boolean;
var
  ini_fun : TiniFile;
  nShowCount : integer;
  nSize : integer;
...
function TfmDoorManagementReport.ReportFieldNameSetting: Boolean;
begin
...
function TfmDoorManagementReport.ReportHeaderNameSetting: Boolean;
begin
...
function TfmDoorManagementReport.SearchReport: Boolean;
var
  stStartDate : string;
  stStartTime : string;
  stEndDate : string;
...
procedure TfmDoorManagementReport.sg_reportColumnMoved(Sender: TObject; FromIndex,
  ToIndex: Integer);
begin
  inherited;
...
procedure TfmDoorManagementReport.tv_buildingNameDblClick(Sender: TObject);
begin
  inherited;
...
function TfmDoorManagementReport.WriteIniConfig: Boolean;
var
  ini_fun : TiniFile;
  i : integer;
begin
...
initialization
  RegisterClass(TfmDoorManagementReport);
Finalization
  UnRegisterClass(TfmDoorManagementReport);
