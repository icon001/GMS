inherited fmAttendSummary: TfmAttendSummary
  Left = 0
  Top = 0
  BorderStyle = bsNone
  Caption = 'fmAttendSummary'
  ClientHeight = 219
  ClientWidth = 433
  Color = clWhite
  Font.Height = -11
  ...
  object GroupBox1: TGroupBox [4]
    ...
    object btn_Summary: TAdvGlowButton
      Left = 151
      Top = 181
      Width = 70
      Height = 20
  ...
  object sg_Employee: TAdvStringGrid [5]
    Left = 168
    Top = 37
    Width = 246
    Height = 88
    ...
    TabOrder = 1
    Visible = False
    OnDblClick = sg_EmployeeDblClick
