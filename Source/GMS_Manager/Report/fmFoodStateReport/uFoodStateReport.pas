...
type
  TfmFoodStateReport = class(TfmASubForm)
    Image1: TImage;
...
var
  fmFoodStateReport: TfmFoodStateReport;
...
function TfmFoodStateReport.AttendReportFieldNameSetting: Boolean;
begin
...
function TfmFoodStateReport.AttendReportHeaderNameSetting(
...
procedure TfmFoodStateReport.btn_CloseClick(Sender: TObject);
begin
  inherited;
  Close;
end;

procedure TfmFoodStateReport.btn_ExcelClick(Sender: TObject);
var
...
procedure TfmFoodStateReport.btn_minimizeClick(Sender: TObject);
begin
  inherited;
  windowState := wsNormal;
end;

procedure TfmFoodStateReport.btn_OptionCancelClick(Sender: TObject);
begin
  inherited;
  Pan_Option.Visible := False;
end;

procedure TfmFoodStateReport.btn_OptionClick(Sender: TObject);
var
  i : integer;
begin
  inherited;
...
procedure TfmFoodStateReport.btn_OptionSaveClick(Sender: TObject);
var
  ini_fun : TiniFile;
  i : integer;
begin
  Try
    ini_fun := TiniFile.Create(G_stExeFolder + '\FoodStateReport.INI');
    with ini_fun do
    begin
...
procedure TfmFoodStateReport.btn_PrintClick(Sender: TObject);
begin
  sg_Report.Print;
end;

procedure TfmFoodStateReport.btn_SearchClick(Sender: TObject);
begin
  inherited;
  SearchReport;
end;

procedure TfmFoodStateReport.ChangeFoodEventReportIndex(FromIndex,
  ToIndex: integer);
var
  i : integer;
  nChangData : integer;
...
procedure TfmFoodStateReport.cmb_ETCChange(Sender: TObject);
begin
  inherited;
  lb_SearchETCName.Caption.Text := cmb_ETC.Text;
end;

procedure TfmFoodStateReport.eb_CompanyNameClickBtn(Sender: TObject);
begin
  inherited;
...
procedure TfmFoodStateReport.ed_AddNameKeyPress(Sender: TObject;
  var Key: Char);
begin
  inherited;
  if Key = #13 then
...
procedure TfmFoodStateReport.ed_nameKeyPress(Sender: TObject; var Key: Char);
begin
  inherited;
  if Key = #13 then
  begin
...
procedure TfmFoodStateReport.FontSetting;
begin
...
procedure TfmFoodStateReport.FormActivate(Sender: TObject);
begin
  inherited;
  WindowState := wsMaximized;
end;

procedure TfmFoodStateReport.FormChangeEvent(aFormName: integer);
begin
end;

procedure TfmFoodStateReport.FormClose(Sender: TObject;
...
function TfmFoodStateReport.FormComboBoxInitialize: Boolean;
var
...
procedure TfmFoodStateReport.FormCreate(Sender: TObject);
begin
...
procedure TfmFoodStateReport.FormGradeRefresh;
begin

end;

function TfmFoodStateReport.FormGridInitialize: Boolean;
begin
  GridInitialize(sg_Report);
  ReportCellHide(sg_Report);
end;

procedure TfmFoodStateReport.FormIDSetting(aID: string);
begin
  L_stMenuID := aID;
end;

function TfmFoodStateReport.FormNameSetting: Boolean;
var
  i : integer;
begin
...
procedure TfmFoodStateReport.FormResize(Sender: TObject);
begin
  inherited;
...
procedure TfmFoodStateReport.FormShow(Sender: TObject);
begin
  fmMain.FORMENABLE(con_FormBMOSFOODSTATEREPORT,'TRUE');
...
function TfmFoodStateReport.MemoryCreate: Boolean;
begin
...
function TfmFoodStateReport.MemoryFree: Boolean;
begin
...
function TfmFoodStateReport.ReportCellHide(aList: TAdvStringGrid): Boolean;
var
  i : integer;
begin
...
function TfmFoodStateReport.ReportConfigRead: Boolean;
var
  ini_fun : TiniFile;
  nShowCount : integer;
  nSize : integer;
...
function TfmFoodStateReport.ReportHeaderNameSetting: Boolean;
begin
...
function TfmFoodStateReport.SearchReport: Boolean;
var
  stStartDate : string;
  stEndDate : string;
  stCompanyCode : string;
...
begin
  ...
  stSql :=  dmDBSelect.SelectTB_FOODEVENT_FoodStateReport(stStartDate,stEndDate, stCompanyCode,
            stPosiCode, stEmpGubun, stEtcType, stEtcName,stFdType);
...
procedure TfmFoodStateReport.sg_reportColumnMoved(Sender: TObject; FromIndex,
  ToIndex: Integer);
begin
  inherited;
...
procedure TfmFoodStateReport.tv_AddCompanyNameDblClick(Sender: TObject);
begin
  inherited;
  Try
...
function TfmFoodStateReport.WriteIniConfig: Boolean;
var
  ini_fun : TiniFile;
  i : integer;
begin
...
initialization
  RegisterClass(TfmFoodStateReport);
Finalization
  UnRegisterClass(TfmFoodStateReport);
