...
begin
  ...
  begin
    ...
    begin
      DockBuildingDoorMonitoring.ManualDock(RightDockPanel,nil,alClient);
...
procedure TfmMergeMonitoring.FontSetting;
begin
...
begin
  inherited;
  fmMain.FORMENABLE(con_FormBMOSMERGEMONITOR,'FALSE');
...
procedure TfmMergeMonitoring.FormGradeRefresh;
begin
...
procedure TfmMergeMonitoring.FormIDSetting(aID: string);
begin
  L_stMenuID := aID;
end;
...
//  WindowState := wsMinimized;
  ...
  FormNameSetting;
  fmMain.FORMENABLE(con_FormBMOSMERGEMONITOR,'TRUE');
