...
uses
  ...
  uAccessMonitoringEvent,uSecurityMonitoringEvent, AdvOfficeTabSet,
...
type
  TfmMergeEvent = class(TfmASubForm)
    ...
    procedure TopDockPanelResize(Sender: TObject);
  private
...
procedure TfmMergeEvent.TopDockPanelResize(Sender: TObject);
begin
  inherited;
  if Not L_bAccessEventDocking then Exit;

  TopDockPanel.DockSite := True;
...
procedure TfmMergeEvent.FontSetting;
begin
...
begin
  ...
  begin
    ...
    begin
      DockAccessEvent.ManualDock(TopDockPanel,nil,alClient);
