    ...
    begin
      ...
      begin
        ...
        begin
          ...
          begin
            dmDBCardPermit.EmGroupArmAreaPermitLikeAdd(ed_GradeEmGroupCode.Text,Cells[2,i],Cells[3,i],Cells[4,i],Cells[5,i]);
          end else
          begin
    ...
    begin
      ...
      begin
        ...
        begin
          if G_bChildGradeSync then
          begin
            dmDBCardPermit.EmGroupArmAreaPermitLikeDelete(ed_GradeEmGroupCode.Text,Cells[2,i],Cells[3,i],Cells[4,i],Cells[5,i]);
          end else
          begin
    ...
    begin
      ...
      begin
        ...
        begin
          if G_bChildGradeSync then
          begin
            dmDBCardPermit.EmGroupDoorPermitLikeDelete(ed_GradeEmGroupCode.Text,Cells[2,i],Cells[3,i],Cells[4,i],Cells[5,i]);
          end else
          begin
