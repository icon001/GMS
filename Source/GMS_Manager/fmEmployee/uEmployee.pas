...
type
  TfmEmployee = class(TfmASubForm)
    ...
    SearchTimer: TTimer;
    chk_NotCompany: TAdvOfficeCheckBox;
...
begin
  ...
  chk_NotCompany.Checked := False;
  chk_NotCompany.Visible := G_bCompanyCodeNotMatch;
end;
...
begin
  ...
  if G_nBMSType = 2 then
    stSql := dmDBSelect.SelectTB_EMPLOYE_Value(stCompanyCode,stPosiCode,'',stEmCode,stEmName,stEmployeeGubun,stEmHandPhone,stEmCompanyPhone,stEtcInfo,'','','1','','',chk_IncludeCardNum.Checked,'','',stCardNo,'','',stCardState,Not chk_NotCompany.Checked)  //출입타입
  else if G_nBMSType = 3 then
    stSql := dmDBSelect.SelectTB_EMPLOYE_Value(stCompanyCode,stPosiCode,'',stEmCode,stEmName,stEmployeeGubun,stEmHandPhone,stEmCompanyPhone,stEtcInfo,'','','','1','',chk_IncludeCardNum.Checked,'','',stCardNo,'','',stCardState,Not chk_NotCompany.Checked)  //근태타입
  else if G_nBMSType = 4 then
    stSql := dmDBSelect.SelectTB_EMPLOYE_Value(stCompanyCode,stPosiCode,'',stEmCode,stEmName,stEmployeeGubun,stEmHandPhone,stEmCompanyPhone,stEtcInfo,'','','','','1',chk_IncludeCardNum.Checked,'','',stCardNo,'','',stCardState,Not chk_NotCompany.Checked)  //식수타입
  ;
  Try
