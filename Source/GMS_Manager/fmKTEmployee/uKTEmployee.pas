...
type
  ...
  private
    L_bSearchEnd : Boolean; //다른 소속 재 조회
...
begin
  ...
  if G_nEmployeeSearchType = 1 then SearchEmployeeList(ed_emGradeSeq.Text,sg_EmployeeList.TopRow);
end;
...
procedure TfmKTEmployee.btn_AccessConfirmClick(Sender: TObject);
begin
  inherited;
  L_bSearchEnd := True;
...
procedure TfmKTEmployee.btn_EmployeeDeleteClick(Sender: TObject);
begin
  inherited;
  pm_EmDeleteClick(pm_EmDelete);
end;

procedure TfmKTEmployee.btn_EmployeeGubunAddClick(Sender: TObject);
begin
  inherited;
...
procedure TfmKTEmployee.btn_PositionAddClick(Sender: TObject);
begin
  inherited;
...
{  if rg_TimeGroup.ItemIndex = 0 then
  ...
  begin
    ...
    begin
      ...
      begin
        pan_progress.Visible := True;
        lb_ProgressCount.Caption.Text := cmb_EmCardGradeType.Text + ' 권한 적용중...';
        Application.ProcessMessages;
    ...
    fmMain.FORMCHANGE(con_FormBMOSKTEMPLOYEE,'');
  ...
  pan_progress.Visible := True;
  lb_ProgressCount.Caption.Text := '변경 권한 적용중...';
...
begin
  ...
  begin
    ...
    ed_CardPrintNo.Text := dmDBFunction.GetTB_CARDPRINTLIST_PrintNoFromCardNo(aCardNo);
...
//  dmSupremaFinger.Free;
  ...
  fmMain.FORMENABLE(con_FormBMOSKTEMPLOYEE,'FALSE');
...
procedure TfmKTEmployee.FormSearchEnable(aEnabled: Boolean);
begin
...
begin
  ...
  FormNameSetting;
  fmMain.FORMENABLE(con_FormBMOSKTEMPLOYEE,'TRUE');
