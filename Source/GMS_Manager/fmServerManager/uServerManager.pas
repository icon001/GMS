...
begin
  ...
  lb_List.Caption := dmFormFunction.GetFormName('1','1','BM2_05');//dmFormFunction.GetFormName('0','2','COMMONLIST01');
  ...
  sg_List.Cells[3,0] := dmFormFunction.GetFormName('0','2','COMMONSERVERIP');
  sg_List.Cells[4,0] := dmFormFunction.GetFormName('0','2','COMMONSERVERMPORT');
  sg_List.Cells[5,0] := dmFormFunction.GetFormName('0','2','COMMONSERVERCPORT');
  sg_List.Cells[6,0] := dmFormFunction.GetFormName('0','2','COMMONSERVERTYPE');
  sg_List.Cells[7,0] := dmFormFunction.GetFormName('0','2','COMMONSERVERFPORT');
  sg_List.Cells[8,0] := dmFormFunction.GetFormName('0','2','COMMONSERVERDPORT');

  lb_ServerName.Caption.Text := dmFormFunction.GetFormName('0','2','COMMONSERVERNAME');
  lb_SocketType.Caption.Text := dmFormFunction.GetFormName('0','2','COMMONSERVERSOCKETTYPE');
  lb_DecoderIp.Caption.Text := dmFormFunction.GetFormName('0','2','COMMONSERVERIP');
  lb_MonitoringPort.Caption.Text := dmFormFunction.GetFormName('0','2','COMMONSERVERMPORT');
  lb_ControlPort.Caption.Text := dmFormFunction.GetFormName('0','2','COMMONSERVERCPORT');
  lb_FTPPort.Caption.Text := dmFormFunction.GetFormName('0','2','COMMONSERVERFPORT');
  lb_DirectPort.Caption.Text := dmFormFunction.GetFormName('0','2','COMMONSERVERDPORT');
...
begin
  ...
  if (sg_List.ColWidths[0] + sg_List.ColWidths[1] + sg_List.ColWidths[2] + sg_List.ColWidths[3] + sg_List.ColWidths[4] + sg_List.ColWidths[5] + sg_List.ColWidths[6] + sg_List.ColWidths[7] + sg_List.ColWidths[8])   < sg_List.Width - 10 then
  begin
    sg_List.ColWidths[8] := sg_List.Width - (sg_List.ColWidths[0] + sg_List.ColWidths[1] + sg_List.ColWidths[2] + sg_List.ColWidths[3] + sg_List.ColWidths[4] + sg_List.ColWidths[5] + sg_List.ColWidths[6] + sg_List.ColWidths[7]) - 10;
  end;
    ...
    begin
      ...
      begin
        ...
        begin
          ...
          cells[8,nRow] := FindField('ND_DIRECTPORT').AsString;
...
begin
  ...
  begin
    ...
    ed_DirectPort.Text := cells[8,Row];
...
begin
  ...
  if dmDBFunction.CheckTB_Decoder_IP(ed_DecoderIP.Text,ed_DirectPort.Text,ed_DecoderNo.Text) = 1 then
  begin
    stMessage := dmFormMessage.GetMessage('DBDATADUP');
    Application.MessageBox(PChar(stMessage),'Error',MB_OK);
    Exit;
  ...
  if Not dmDBUpdate.UpdateTB_Decoder_Value(stDecoderNo,ed_ServerName.Text,inttostr(cmb_SocketType.ItemIndex + 1),ed_DecoderIP.Text,ed_MonitoringServerPort.Text,ed_ControlerServerPort.Text,ed_FTPPort.Text,ed_DirectPort.Text) then
  begin
    stMessage := stringReplace(dmFormMessage.GetMessage('DBSAVEERROR'),'$WORK',btn_Save.Caption,[rfReplaceAll]);
    Application.MessageBox(PChar(stMessage),'Error',MB_OK);
    Exit;
